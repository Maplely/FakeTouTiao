.class public final Lcom/squareup/okio/InflaterSource;
...
# direct methods
.method constructor <init>(Lcom/squareup/okio/BufferedSource;Ljava/util/zip/Inflater;)V
    .locals 2
    ...
    .line 51
    :cond_1
    iput-object p1, p0, Lcom/squareup/okio/InflaterSource;->source:Lcom/squareup/okio/BufferedSource;

    .line 52
    iput-object p2, p0, Lcom/squareup/okio/InflaterSource;->inflater:Ljava/util/zip/Inflater;

    .line 53
    return-void
.end method

.method public constructor <init>(Lcom/squareup/okio/Source;Ljava/util/zip/Inflater;)V
    .locals 1
    ...
    invoke-direct {p0, v0, p2}, Lcom/squareup/okio/InflaterSource;-><init>(Lcom/squareup/okio/BufferedSource;Ljava/util/zip/Inflater;)V
...
.method private releaseInflatedBytes()V
    ...
    .prologue
    .line 112
    iget v1, p0, Lcom/squareup/okio/InflaterSource;->bufferBytesHeldByInflater:I
    ...
    iget-object v2, p0, Lcom/squareup/okio/InflaterSource;->inflater:Ljava/util/zip/Inflater;
    ...
    iput v1, p0, Lcom/squareup/okio/InflaterSource;->bufferBytesHeldByInflater:I

    .line 115
    iget-object v1, p0, Lcom/squareup/okio/InflaterSource;->source:Lcom/squareup/okio/BufferedSource;
...
.method public close()V
    ...
    .prologue
    .line 123
    iget-boolean v0, p0, Lcom/squareup/okio/InflaterSource;->closed:Z
    ...
    .line 124
    :cond_0
    iget-object v0, p0, Lcom/squareup/okio/InflaterSource;->inflater:Ljava/util/zip/Inflater;
    ...
    iput-boolean v0, p0, Lcom/squareup/okio/InflaterSource;->closed:Z

    .line 126
    iget-object v0, p0, Lcom/squareup/okio/InflaterSource;->source:Lcom/squareup/okio/BufferedSource;
...
.method public read(Lcom/squareup/okio/Buffer;J)J
    ...
    .line 58
    :cond_0
    iget-boolean v6, p0, Lcom/squareup/okio/InflaterSource;->closed:Z
    ...
    .line 62
    :cond_2
    invoke-virtual {p0}, Lcom/squareup/okio/InflaterSource;->refill()Z
    ...
    iget-object v4, p0, Lcom/squareup/okio/InflaterSource;->inflater:Ljava/util/zip/Inflater;

    iget-object v5, v3, Lcom/squareup/okio/Segment;->data:[B

    iget v6, v3, Lcom/squareup/okio/Segment;->limit:I

    iget v7, v3, Lcom/squareup/okio/Segment;->limit:I
    ...
    .line 74
    :cond_4
    invoke-direct {p0}, Lcom/squareup/okio/InflaterSource;->releaseInflatedBytes()V
    ...
    .line 77
    invoke-virtual {v3}, Lcom/squareup/okio/Segment;->pop()Lcom/squareup/okio/Segment;
    ...
    .line 78
    invoke-static {v3}, Lcom/squareup/okio/SegmentPool;->recycle(Lcom/squareup/okio/Segment;)V
...
.method public refill()Z
    ...
    .line 101
    :cond_1
    iget-object v2, p0, Lcom/squareup/okio/InflaterSource;->source:Lcom/squareup/okio/BufferedSource;
    ...
    invoke-interface {v2}, Lcom/squareup/okio/BufferedSource;->buffer()Lcom/squareup/okio/Buffer;

    move-result-object v2

    iget-object v0, v2, Lcom/squareup/okio/Buffer;->head:Lcom/squareup/okio/Segment;
    ...
    iput v2, p0, Lcom/squareup/okio/InflaterSource;->bufferBytesHeldByInflater:I
    ...
    iget v5, p0, Lcom/squareup/okio/InflaterSource;->bufferBytesHeldByInflater:I
