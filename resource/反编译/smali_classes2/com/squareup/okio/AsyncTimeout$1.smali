.class Lcom/squareup/okio/AsyncTimeout$1;
...
.method public close()V
    ...
    invoke-virtual {v2}, Lcom/squareup/okio/AsyncTimeout;->enter()V

    .line 208
    :try_start_0
    iget-object v2, p0, Lcom/squareup/okio/AsyncTimeout$1;->val$sink:Lcom/squareup/okio/Sink;

    invoke-interface {v2}, Lcom/squareup/okio/Sink;->close()V
    :try_end_0
    ...
    iget-object v3, p0, Lcom/squareup/okio/AsyncTimeout$1;->this$0:Lcom/squareup/okio/AsyncTimeout;
...
.method public flush()V
    ...
    invoke-interface {v2}, Lcom/squareup/okio/Sink;->flush()V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public write(Lcom/squareup/okio/Buffer;J)V
    ...
    invoke-interface {v0, p1, v10, v11}, Lcom/squareup/okio/Sink;->write(Lcom/squareup/okio/Buffer;J)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0, v9}, Lcom/squareup/okio/AsyncTimeout;->exit(Z)V
    ...
    invoke-virtual {v0, v6}, Lcom/squareup/okio/AsyncTimeout;->exit(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-virtual {v1, v9}, Lcom/squareup/okio/AsyncTimeout;->exit(Z)V

    throw v0

    .line 189
    .end local v7    # "s":Lcom/squareup/okio/Segment;
    .end local v9    # "throwOnTimeout":Z
