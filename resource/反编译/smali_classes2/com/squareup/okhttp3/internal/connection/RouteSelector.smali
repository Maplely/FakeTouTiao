...
.method public constructor <init>(Lcom/squareup/okhttp3/Address;Lcom/squareup/okhttp3/internal/connection/RouteDatabase;)V
    ...
    .param p2, "routeDatabase"    # Lcom/squareup/okhttp3/internal/connection/RouteDatabase;
...
.method private nextProxy()Ljava/net/Proxy;
    ...
    iget-object v3, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->address:Lcom/squareup/okhttp3/Address;
    ...
    iget-object v3, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->proxies:Ljava/util/List;
    ...
    iget v2, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->nextProxyIndex:I

    add-int/lit8 v3, v2, 0x1

    iput v3, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->nextProxyIndex:I
...
.method private resetNextInetSocketAddress(Ljava/net/Proxy;)V
    ...
    iput-object v8, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->inetSocketAddresses:Ljava/util/List;
    ...
    .line 150
    :cond_0
    iget-object v8, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->address:Lcom/squareup/okhttp3/Address;

    invoke-virtual {v8}, Lcom/squareup/okhttp3/Address;->url()Lcom/squareup/okhttp3/HttpUrl;

    move-result-object v8

    invoke-virtual {v8}, Lcom/squareup/okhttp3/HttpUrl;->host()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Lcom/squareup/okhttp3/HttpUrl;->port()I
    ...
    invoke-static {v4}, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->getHostString(Ljava/net/InetSocketAddress;)Ljava/lang/String;
    ...
    .line 169
    iget-object v8, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->inetSocketAddresses:Ljava/util/List;
    ...
    iput v8, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->nextInetSocketAddressIndex:I
    ...
    invoke-virtual {v8}, Lcom/squareup/okhttp3/Address;->dns()Lcom/squareup/okhttp3/Dns;

    move-result-object v8

    invoke-interface {v8, v6}, Lcom/squareup/okhttp3/Dns;->lookup(Ljava/lang/String;)Ljava/util/List;
...
.method private resetNextProxy(Lcom/squareup/okhttp3/HttpUrl;Ljava/net/Proxy;)V
    ...
    iput-object v1, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->proxies:Ljava/util/List;

    .line 123
    :goto_0
    const/4 v1, 0x0

    iput v1, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->nextProxyIndex:I
    ...
    invoke-virtual {v1}, Lcom/squareup/okhttp3/Address;->proxySelector()Ljava/net/ProxySelector;
...
.method public connectFailed(Lcom/squareup/okhttp3/Route;Ljava/io/IOException;)V
    .locals 3
    .param p1, "failedRoute"    # Lcom/squareup/okhttp3/Route;
...
.method public next()Lcom/squareup/okhttp3/Route;
    ...
    iput-object v1, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->lastProxy:Ljava/net/Proxy;
    ...
    iput-object v1, p0, Lcom/squareup/okhttp3/internal/connection/RouteSelector;->lastInetSocketAddress:Ljava/net/InetSocketAddress;
    ...
    .line 85
    .local v0, "route":Lcom/squareup/okhttp3/Route;
