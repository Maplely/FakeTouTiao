...
.method private createAddress(Lcom/squareup/okhttp3/HttpUrl;)Lcom/squareup/okhttp3/Address;
    ...
    .line 191
    .local v7, "certificatePinner":Lcom/squareup/okhttp3/CertificatePinner;
...
.method private followUpRequest(Lcom/squareup/okhttp3/Response;)Lcom/squareup/okhttp3/Request;
    ...
    .line 265
    :cond_0
    iget-object v10, p0, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->streamAllocation:Lcom/squareup/okhttp3/internal/connection/StreamAllocation;

    invoke-virtual {v10}, Lcom/squareup/okhttp3/internal/connection/StreamAllocation;->connection()Lcom/squareup/okhttp3/internal/connection/RealConnection;

    move-result-object v0

    .line 266
    .local v0, "connection":Lcom/squareup/okhttp3/Connection;
    if-eqz v0, :cond_2
    ...
    .line 269
    .local v5, "route":Lcom/squareup/okhttp3/Route;
    :goto_0
    ...
    invoke-virtual {v10}, Lcom/squareup/okhttp3/Request;->method()Ljava/lang/String;
    ...
    .end local v5    # "route":Lcom/squareup/okhttp3/Route;
    :cond_2
    move-object v5, v9
    ...
    .restart local v5    # "route":Lcom/squareup/okhttp3/Route;
    :sswitch_0
    if-eqz v5, :cond_3

    invoke-virtual {v5}, Lcom/squareup/okhttp3/Route;->proxy()Ljava/net/Proxy;
    ...
    invoke-virtual {v9}, Lcom/squareup/okhttp3/OkHttpClient;->proxyAuthenticator()Lcom/squareup/okhttp3/Authenticator;

    move-result-object v9

    invoke-interface {v9, v5, p1}, Lcom/squareup/okhttp3/Authenticator;->authenticate(Lcom/squareup/okhttp3/Route;Lcom/squareup/okhttp3/Response;)Lcom/squareup/okhttp3/Request;
    ...
    invoke-virtual {v9}, Lcom/squareup/okhttp3/OkHttpClient;->authenticator()Lcom/squareup/okhttp3/Authenticator;
    ...
    invoke-virtual {v10}, Lcom/squareup/okhttp3/OkHttpClient;->followRedirects()Z
    ...
    invoke-virtual {p1, v10}, Lcom/squareup/okhttp3/Response;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v10}, Lcom/squareup/okhttp3/Request;->url()Lcom/squareup/okhttp3/HttpUrl;

    move-result-object v10

    invoke-virtual {v10, v1}, Lcom/squareup/okhttp3/HttpUrl;->resolve(Ljava/lang/String;)Lcom/squareup/okhttp3/HttpUrl;

    move-result-object v8

    .line 305
    .local v8, "url":Lcom/squareup/okhttp3/HttpUrl;
    if-eqz v8, :cond_1

    .line 308
    invoke-virtual {v8}, Lcom/squareup/okhttp3/HttpUrl;->scheme()Ljava/lang/String;
    ...
    invoke-virtual {v11}, Lcom/squareup/okhttp3/Request;->url()Lcom/squareup/okhttp3/HttpUrl;
    ...
    invoke-virtual {v10}, Lcom/squareup/okhttp3/OkHttpClient;->followSslRedirects()Z
    ...
    invoke-virtual {v10}, Lcom/squareup/okhttp3/Request;->newBuilder()Lcom/squareup/okhttp3/Request$Builder;

    move-result-object v3

    .line 313
    .local v3, "requestBuilder":Lcom/squareup/okhttp3/Request$Builder;
    invoke-static {v2}, Lcom/squareup/okhttp3/internal/http/HttpMethod;->permitsRequestBody(Ljava/lang/String;)Z
    ...
    .line 314
    invoke-static {v2}, Lcom/squareup/okhttp3/internal/http/HttpMethod;->redirectsToGet(Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, v10, v9}, Lcom/squareup/okhttp3/Request$Builder;->method(Ljava/lang/String;Lcom/squareup/okhttp3/RequestBody;)Lcom/squareup/okhttp3/Request$Builder;

    .line 319
    :goto_3
    const-string v9, "Transfer-Encoding"

    invoke-virtual {v3, v9}, Lcom/squareup/okhttp3/Request$Builder;->removeHeader(Ljava/lang/String;)Lcom/squareup/okhttp3/Request$Builder;
    ...
    .line 327
    :cond_7
    invoke-direct {p0, p1, v8}, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->sameConnection(Lcom/squareup/okhttp3/Response;Lcom/squareup/okhttp3/HttpUrl;)Z
    ...
    .line 331
    :cond_8
    invoke-virtual {v3, v8}, Lcom/squareup/okhttp3/Request$Builder;->url(Lcom/squareup/okhttp3/HttpUrl;)Lcom/squareup/okhttp3/Request$Builder;

    move-result-object v9

    invoke-virtual {v9}, Lcom/squareup/okhttp3/Request$Builder;->build()Lcom/squareup/okhttp3/Request;
    ...
    .line 317
    :cond_9
    invoke-virtual {v3, v2, v9}, Lcom/squareup/okhttp3/Request$Builder;->method(Ljava/lang/String;Lcom/squareup/okhttp3/RequestBody;)Lcom/squareup/okhttp3/Request$Builder;

    goto :goto_3

    .line 337
    .end local v1    # "location":Ljava/lang/String;
    .end local v3    # "requestBuilder":Lcom/squareup/okhttp3/Request$Builder;
    .end local v6    # "sameScheme":Z
    .end local v8    # "url":Lcom/squareup/okhttp3/HttpUrl;
    :sswitch_4
    invoke-virtual {p1}, Lcom/squareup/okhttp3/Response;->request()Lcom/squareup/okhttp3/Request;

    move-result-object v10

    invoke-virtual {v10}, Lcom/squareup/okhttp3/Request;->body()Lcom/squareup/okhttp3/RequestBody;

    move-result-object v10

    instance-of v10, v10, Lcom/squareup/okhttp3/internal/http/UnrepeatableRequestBody;
...
.method private recover(Ljava/io/IOException;ZLcom/squareup/okhttp3/Request;)Z
    ...
    .param p1, "e"    # Ljava/io/IOException;
    .param p2, "routeException"    # Z
    .param p3, "userRequest"    # Lcom/squareup/okhttp3/Request;
...
.method private sameConnection(Lcom/squareup/okhttp3/Response;Lcom/squareup/okhttp3/HttpUrl;)Z
    ...
    .param p2, "followUp"    # Lcom/squareup/okhttp3/HttpUrl;
    ...
    .line 354
    .local v0, "url":Lcom/squareup/okhttp3/HttpUrl;
...
.method public cancel()V
    ...
    iput-boolean v1, p0, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->canceled:Z
    ...
    .line 84
    .local v0, "streamAllocation":Lcom/squareup/okhttp3/internal/connection/StreamAllocation;
    if-eqz v0, :cond_0
...
.method public intercept(Lcom/squareup/okhttp3/Interceptor$Chain;)Lcom/squareup/okhttp3/Response;
    ...
    .line 110
    .local v6, "request":Lcom/squareup/okhttp3/Request;
    new-instance v8, Lcom/squareup/okhttp3/internal/connection/StreamAllocation;

    iget-object v9, p0, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->client:Lcom/squareup/okhttp3/OkHttpClient;

    invoke-virtual {v9}, Lcom/squareup/okhttp3/OkHttpClient;->connectionPool()Lcom/squareup/okhttp3/ConnectionPool;

    move-result-object v9

    invoke-virtual {v6}, Lcom/squareup/okhttp3/Request;->url()Lcom/squareup/okhttp3/HttpUrl;

    move-result-object v10

    invoke-direct {p0, v10}, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->createAddress(Lcom/squareup/okhttp3/HttpUrl;)Lcom/squareup/okhttp3/Address;

    move-result-object v10

    invoke-direct {v8, v9, v10}, Lcom/squareup/okhttp3/internal/connection/StreamAllocation;-><init>(Lcom/squareup/okhttp3/ConnectionPool;Lcom/squareup/okhttp3/Address;)V

    iput-object v8, p0, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->streamAllocation:Lcom/squareup/okhttp3/internal/connection/StreamAllocation;
    ...
    .line 116
    .local v4, "priorResponse":Lcom/squareup/okhttp3/Response;
    :cond_0
    :goto_0
    iget-boolean v8, p0, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->canceled:Z

    if-eqz v8, :cond_1

    .line 117
    iget-object v8, p0, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->streamAllocation:Lcom/squareup/okhttp3/internal/connection/StreamAllocation;

    invoke-virtual {v8}, Lcom/squareup/okhttp3/internal/connection/StreamAllocation;->release()V
    ...
    .line 122
    .local v7, "response":Lcom/squareup/okhttp3/Response;
    const/4 v5, 0x1
    ...
    iget-object v9, p0, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->streamAllocation:Lcom/squareup/okhttp3/internal/connection/StreamAllocation;

    const/4 v10, 0x0

    const/4 v11, 0x0

    invoke-virtual {v8, v6, v9, v10, v11}, Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;->proceed(Lcom/squareup/okhttp3/Request;Lcom/squareup/okhttp3/internal/connection/StreamAllocation;Lcom/squareup/okhttp3/internal/http/HttpStream;Lcom/squareup/okhttp3/Connection;)Lcom/squareup/okhttp3/Response;
    :try_end_0
    ...
    invoke-virtual {v8, v12}, Lcom/squareup/okhttp3/internal/connection/StreamAllocation;->streamFailed(Ljava/io/IOException;)V
    ...
    .line 146
    invoke-virtual {v7}, Lcom/squareup/okhttp3/Response;->newBuilder()Lcom/squareup/okhttp3/Response$Builder;
    ...
    invoke-virtual {v9, v12}, Lcom/squareup/okhttp3/Response$Builder;->body(Lcom/squareup/okhttp3/ResponseBody;)Lcom/squareup/okhttp3/Response$Builder;
    ...
    invoke-virtual {v8, v9}, Lcom/squareup/okhttp3/Response$Builder;->priorResponse(Lcom/squareup/okhttp3/Response;)Lcom/squareup/okhttp3/Response$Builder;

    move-result-object v8

    invoke-virtual {v8}, Lcom/squareup/okhttp3/Response$Builder;->build()Lcom/squareup/okhttp3/Response;

    move-result-object v7

    .line 153
    :cond_3
    invoke-direct {p0, v7}, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->followUpRequest(Lcom/squareup/okhttp3/Response;)Lcom/squareup/okhttp3/Request;

    move-result-object v2

    .line 155
    .local v2, "followUp":Lcom/squareup/okhttp3/Request;
    if-nez v2, :cond_8

    .line 156
    iget-boolean v8, p0, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->forWebSocket:Z
    ...
    .line 126
    .end local v2    # "followUp":Lcom/squareup/okhttp3/Request;
    :catch_0
    move-exception v1

    .line 128
    .local v1, "e":Lcom/squareup/okhttp3/internal/connection/RouteException;
    :try_start_1
    ...
    invoke-direct {p0, v8, v9, v6}, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;ZLcom/squareup/okhttp3/Request;)Z
    ...
    .line 138
    .end local v1    # "e":Lcom/squareup/okhttp3/internal/connection/RouteException;
    :catchall_0
    move-exception v8
    ...
    invoke-virtual {v9, v12}, Lcom/squareup/okhttp3/internal/connection/StreamAllocation;->streamFailed(Ljava/io/IOException;)V

    .line 140
    iget-object v9, p0, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->streamAllocation:Lcom/squareup/okhttp3/internal/connection/StreamAllocation;

    invoke-virtual {v9}, Lcom/squareup/okhttp3/internal/connection/StreamAllocation;->release()V

    :cond_5
    throw v8

    .line 129
    .restart local v1    # "e":Lcom/squareup/okhttp3/internal/connection/RouteException;
    :cond_6
    const/4 v5, 0x0
    ...
    :try_start_2
    invoke-direct {p0, v1, v8, v6}, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;ZLcom/squareup/okhttp3/Request;)Z
    ...
    .restart local v2    # "followUp":Lcom/squareup/okhttp3/Request;
    :cond_8
    invoke-virtual {v7}, Lcom/squareup/okhttp3/Response;->body()Lcom/squareup/okhttp3/ResponseBody;

    move-result-object v8

    invoke-static {v8}, Lcom/squareup/okhttp3/internal/Util;->closeQuietly(Ljava/io/Closeable;)V
    ...
    .line 169
    :cond_9
    invoke-virtual {v2}, Lcom/squareup/okhttp3/Request;->body()Lcom/squareup/okhttp3/RequestBody;

    move-result-object v8

    instance-of v8, v8, Lcom/squareup/okhttp3/internal/http/UnrepeatableRequestBody;
    ...
    invoke-virtual {v7}, Lcom/squareup/okhttp3/Response;->code()I
    ...
    invoke-direct {p0, v7, v8}, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->sameConnection(Lcom/squareup/okhttp3/Response;Lcom/squareup/okhttp3/HttpUrl;)Z
    ...
    invoke-virtual {v8}, Lcom/squareup/okhttp3/internal/connection/StreamAllocation;->stream()Lcom/squareup/okhttp3/internal/http/HttpStream;
