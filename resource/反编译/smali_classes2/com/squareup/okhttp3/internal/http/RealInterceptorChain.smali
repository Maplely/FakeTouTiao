...
.method public constructor <init>(Ljava/util/List;Lcom/squareup/okhttp3/internal/connection/StreamAllocation;Lcom/squareup/okhttp3/internal/http/HttpStream;Lcom/squareup/okhttp3/Connection;ILcom/squareup/okhttp3/Request;)V
    ...
    .param p3, "httpStream"    # Lcom/squareup/okhttp3/internal/http/HttpStream;
    .param p4, "connection"    # Lcom/squareup/okhttp3/Connection;
    .param p5, "index"    # I
    .param p6, "request"    # Lcom/squareup/okhttp3/Request;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List",
    ...
    .prologue
    .line 41
    .local p1, "interceptors":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/Interceptor;>;"
...
.method public proceed(Lcom/squareup/okhttp3/Request;Lcom/squareup/okhttp3/internal/connection/StreamAllocation;Lcom/squareup/okhttp3/internal/http/HttpStream;Lcom/squareup/okhttp3/Connection;)Lcom/squareup/okhttp3/Response;
    ...
    .line 72
    iget v1, p0, Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;->index:I
    ...
    .line 74
    :cond_0
    iget v1, p0, Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;->calls:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;->calls:I
    ...
    invoke-direct {p0, v1}, Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;->sameConnection(Lcom/squareup/okhttp3/HttpUrl;)Z
    ...
    iget-object v3, p0, Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;->interceptors:Ljava/util/List;

    iget v4, p0, Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;->index:I
    ...
    .line 91
    .local v0, "next":Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;
    iget-object v1, p0, Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;->interceptors:Ljava/util/List;
    ...
    check-cast v7, Lcom/squareup/okhttp3/Interceptor;

    .line 92
    .local v7, "interceptor":Lcom/squareup/okhttp3/Interceptor;
    invoke-interface {v7, v0}, Lcom/squareup/okhttp3/Interceptor;->intercept(Lcom/squareup/okhttp3/Interceptor$Chain;)Lcom/squareup/okhttp3/Response;

    move-result-object v8

    .line 95
    .local v8, "response":Lcom/squareup/okhttp3/Response;
    if-eqz p3, :cond_3
    ...
    iget v1, v0, Lcom/squareup/okhttp3/internal/http/RealInterceptorChain;->calls:I
