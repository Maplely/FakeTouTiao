...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/squareup/okhttp3/internal/http/Http1xStream$1;,
...
.method public constructor <init>(Lcom/squareup/okhttp3/OkHttpClient;Lcom/squareup/okhttp3/internal/connection/StreamAllocation;Lcom/squareup/okio/BufferedSource;Lcom/squareup/okio/BufferedSink;)V
    ...
    .param p4, "sink"    # Lcom/squareup/okio/BufferedSink;
...
.method static synthetic access$300(Lcom/squareup/okhttp3/internal/http/Http1xStream;)Lcom/squareup/okio/BufferedSink;
    .locals 1
    .param p0, "x0"    # Lcom/squareup/okhttp3/internal/http/Http1xStream;
...
.method static synthetic access$400(Lcom/squareup/okhttp3/internal/http/Http1xStream;Lcom/squareup/okio/ForwardingTimeout;)V
    .locals 0
    .param p0, "x0"    # Lcom/squareup/okhttp3/internal/http/Http1xStream;
    .param p1, "x1"    # Lcom/squareup/okio/ForwardingTimeout;
...
.method private detachTimeout(Lcom/squareup/okio/ForwardingTimeout;)V
    .locals 2
    .param p1, "timeout"    # Lcom/squareup/okio/ForwardingTimeout;
    ...
    .line 256
    .local v0, "oldDelegate":Lcom/squareup/okio/Timeout;
...
.method private getTransferStream(Lcom/squareup/okhttp3/Response;)Lcom/squareup/okio/Source;
    ...
    invoke-virtual {p0, v2, v3}, Lcom/squareup/okhttp3/internal/http/Http1xStream;->newFixedLengthSource(J)Lcom/squareup/okio/Source;
    ...
    invoke-virtual {p1, v3}, Lcom/squareup/okhttp3/Response;->header(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lcom/squareup/okhttp3/internal/http/Http1xStream;->newChunkedSource(Lcom/squareup/okhttp3/HttpUrl;)Lcom/squareup/okio/Source;
...
.method public cancel()V
    ...
    .prologue
    .line 106
    iget-object v1, p0, Lcom/squareup/okhttp3/internal/http/Http1xStream;->streamAllocation:Lcom/squareup/okhttp3/internal/connection/StreamAllocation;

    invoke-virtual {v1}, Lcom/squareup/okhttp3/internal/connection/StreamAllocation;->connection()Lcom/squareup/okhttp3/internal/connection/RealConnection;
...
.method public readHeaders()Lcom/squareup/okhttp3/Headers;
    ...
    .line 211
    .local v0, "headers":Lcom/squareup/okhttp3/Headers$Builder;
    :goto_0
    iget-object v2, p0, Lcom/squareup/okhttp3/internal/http/Http1xStream;->source:Lcom/squareup/okio/BufferedSource;
...
.method public readResponse()Lcom/squareup/okhttp3/Response$Builder;
    ...
    .prologue
    .line 180
    iget v4, p0, Lcom/squareup/okhttp3/internal/http/Http1xStream;->state:I
    ...
    iget v6, p0, Lcom/squareup/okhttp3/internal/http/Http1xStream;->state:I
    ...
    :cond_0
    :try_start_0
    iget-object v4, p0, Lcom/squareup/okhttp3/internal/http/Http1xStream;->source:Lcom/squareup/okio/BufferedSource;

    invoke-interface {v4}, Lcom/squareup/okio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;
    ...
    .line 188
    .local v3, "statusLine":Lcom/squareup/okhttp3/internal/http/StatusLine;
    new-instance v4, Lcom/squareup/okhttp3/Response$Builder;

    invoke-direct {v4}, Lcom/squareup/okhttp3/Response$Builder;-><init>()V

    iget-object v5, v3, Lcom/squareup/okhttp3/internal/http/StatusLine;->protocol:Lcom/squareup/okhttp3/Protocol;

    invoke-virtual {v4, v5}, Lcom/squareup/okhttp3/Response$Builder;->protocol(Lcom/squareup/okhttp3/Protocol;)Lcom/squareup/okhttp3/Response$Builder;

    move-result-object v4

    iget v5, v3, Lcom/squareup/okhttp3/internal/http/StatusLine;->code:I

    invoke-virtual {v4, v5}, Lcom/squareup/okhttp3/Response$Builder;->code(I)Lcom/squareup/okhttp3/Response$Builder;

    move-result-object v4

    iget-object v5, v3, Lcom/squareup/okhttp3/internal/http/StatusLine;->message:Ljava/lang/String;

    invoke-virtual {v4, v5}, Lcom/squareup/okhttp3/Response$Builder;->message(Ljava/lang/String;)Lcom/squareup/okhttp3/Response$Builder;
    ...
    invoke-virtual {v4, v5}, Lcom/squareup/okhttp3/Response$Builder;->headers(Lcom/squareup/okhttp3/Headers;)Lcom/squareup/okhttp3/Response$Builder;

    move-result-object v2

    .line 194
    .local v2, "responseBuilder":Lcom/squareup/okhttp3/Response$Builder;
    iget v4, v3, Lcom/squareup/okhttp3/internal/http/StatusLine;->code:I
    ...
    iput v4, p0, Lcom/squareup/okhttp3/internal/http/Http1xStream;->state:I
    :try_end_0
    ...
    .line 199
    .end local v2    # "responseBuilder":Lcom/squareup/okhttp3/Response$Builder;
    .end local v3    # "statusLine":Lcom/squareup/okhttp3/internal/http/StatusLine;
    :catch_0
    move-exception v0
    ...
    iget-object v5, p0, Lcom/squareup/okhttp3/internal/http/Http1xStream;->streamAllocation:Lcom/squareup/okhttp3/internal/connection/StreamAllocation;
...
.method public writeRequest(Lcom/squareup/okhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v2, p2}, Lcom/squareup/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/squareup/okio/BufferedSink;
    ...
    iput v2, p0, Lcom/squareup/okhttp3/internal/http/Http1xStream;->state:I
...
.method public writeRequestHeaders(Lcom/squareup/okhttp3/Request;)V
    ...
    invoke-virtual {v1}, Lcom/squareup/okhttp3/internal/connection/RealConnection;->route()Lcom/squareup/okhttp3/Route;
    ...
    invoke-static {p1, v1}, Lcom/squareup/okhttp3/internal/http/RequestLine;->get(Lcom/squareup/okhttp3/Request;Ljava/net/Proxy$Type;)Ljava/lang/String;
