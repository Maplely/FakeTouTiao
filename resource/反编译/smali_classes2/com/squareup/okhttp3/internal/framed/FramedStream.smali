...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/squareup/okhttp3/internal/framed/FramedStream$1;,
...
.method constructor <init>(ILcom/squareup/okhttp3/internal/framed/FramedConnection;ZZLjava/util/List;)V
    .locals 5
    .param p1, "id"    # I
    .param p2, "connection"    # Lcom/squareup/okhttp3/internal/framed/FramedConnection;
    ...
    .prologue
    .local p5, "requestHeaders":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/internal/framed/Header;>;"
    const/4 v4, 0x0
...
.method static synthetic access$1000(Lcom/squareup/okhttp3/internal/framed/FramedStream;)V
    .locals 0
    .param p0, "x0"    # Lcom/squareup/okhttp3/internal/framed/FramedStream;
...
.method private cancelStreamIfNecessary()V
    ...
    .prologue
    .line 447
    sget-boolean v2, Lcom/squareup/okhttp3/internal/framed/FramedStream;->$assertionsDisabled:Z
    ...
    .line 451
    :try_start_0
    iget-object v2, p0, Lcom/squareup/okhttp3/internal/framed/FramedStream;->source:Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSource;

    # getter for: Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSource;->finished:Z
    invoke-static {v2}, Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSource;->access$100(Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSource;)Z
    ...
    invoke-static {v2}, Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSource;->access$300(Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSource;)Z

    move-result v2

    if-eqz v2, :cond_3

    iget-object v2, p0, Lcom/squareup/okhttp3/internal/framed/FramedStream;->sink:Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSink;

    # getter for: Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSink;->finished:Z
    invoke-static {v2}, Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSink;->access$200(Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSink;)Z
    ...
    invoke-static {v2}, Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSink;->access$400(Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSink;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/squareup/okhttp3/internal/framed/FramedStream;->close(Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    ...
    .line 461
    iget-object v2, p0, Lcom/squareup/okhttp3/internal/framed/FramedStream;->connection:Lcom/squareup/okhttp3/internal/framed/FramedConnection;

    iget v3, p0, Lcom/squareup/okhttp3/internal/framed/FramedStream;->id:I

    invoke-virtual {v2, v3}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->removeStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;
...
.method private closeInternal(Lcom/squareup/okhttp3/internal/framed/ErrorCode;)Z
    .locals 2
    .param p1, "errorCode"    # Lcom/squareup/okhttp3/internal/framed/ErrorCode;
...
.method public close(Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    .locals 2
    .param p1, "rstStatusCode"    # Lcom/squareup/okhttp3/internal/framed/ErrorCode;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method receiveFin()V
    ...
    # setter for: Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSource;->finished:Z
    invoke-static {v1, v2}, Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSource;->access$102(Lcom/squareup/okhttp3/internal/framed/FramedStream$FramedDataSource;Z)Z
    ...
    invoke-virtual {v1, v2}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->removeStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;
...
.method receiveHeaders(Ljava/util/List;Lcom/squareup/okhttp3/internal/framed/HeadersMode;)V
    .locals 5
    .param p2, "headersMode"    # Lcom/squareup/okhttp3/internal/framed/HeadersMode;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List",
    ...
    .prologue
    .line 253
    .local p1, "headers":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/internal/framed/Header;>;"
    sget-boolean v3, Lcom/squareup/okhttp3/internal/framed/FramedStream;->$assertionsDisabled:Z
    ...
    .line 277
    invoke-virtual {p0, v0}, Lcom/squareup/okhttp3/internal/framed/FramedStream;->closeLater(Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    ...
    .line 267
    sget-object v0, Lcom/squareup/okhttp3/internal/framed/ErrorCode;->STREAM_IN_USE:Lcom/squareup/okhttp3/internal/framed/ErrorCode;
    ...
    .line 270
    .local v1, "newHeaders":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/internal/framed/Header;>;"
    iget-object v3, p0, Lcom/squareup/okhttp3/internal/framed/FramedStream;->responseHeaders:Ljava/util/List;
    ...
    .line 272
    iput-object v1, p0, Lcom/squareup/okhttp3/internal/framed/FramedStream;->responseHeaders:Ljava/util/List;
    :try_end_2
    ...
    .line 278
    .end local v1    # "newHeaders":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/internal/framed/Header;>;"
    :cond_5
    if-nez v2, :cond_1
    ...
    iget v4, p0, Lcom/squareup/okhttp3/internal/framed/FramedStream;->id:I

    invoke-virtual {v3, v4}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->removeStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;
...
.method public reply(Ljava/util/List;Z)V
    ...
    .prologue
    .line 163
    .local p1, "responseHeaders":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/internal/framed/Header;>;"
    sget-boolean v1, Lcom/squareup/okhttp3/internal/framed/FramedStream;->$assertionsDisabled:Z
    ...
    invoke-virtual {v1}, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->flush()V
