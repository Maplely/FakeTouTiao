...
.method private constructor <init>(Lcom/squareup/okhttp3/internal/framed/FramedConnection$Builder;)V
    .locals 12
    .param p1, "builder"    # Lcom/squareup/okhttp3/internal/framed/FramedConnection$Builder;
...
.method synthetic constructor <init>(Lcom/squareup/okhttp3/internal/framed/FramedConnection$Builder;Lcom/squareup/okhttp3/internal/framed/FramedConnection$1;)V
    .locals 0
    .param p1, "x0"    # Lcom/squareup/okhttp3/internal/framed/FramedConnection$Builder;
    .param p2, "x1"    # Lcom/squareup/okhttp3/internal/framed/FramedConnection$1;
...
.method static synthetic access$1100(Lcom/squareup/okhttp3/internal/framed/FramedConnection;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/squareup/okhttp3/internal/framed/FramedConnection;
...
.method static synthetic access$1200(Lcom/squareup/okhttp3/internal/framed/FramedConnection;Lcom/squareup/okhttp3/internal/framed/ErrorCode;Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    .locals 0
    .param p0, "x0"    # Lcom/squareup/okhttp3/internal/framed/FramedConnection;
    .param p1, "x1"    # Lcom/squareup/okhttp3/internal/framed/ErrorCode;
    .param p2, "x2"    # Lcom/squareup/okhttp3/internal/framed/ErrorCode;
...
.method static synthetic access$1400(Lcom/squareup/okhttp3/internal/framed/FramedConnection;ILcom/squareup/okio/BufferedSource;IZ)V
    ...
    .param p0, "x0"    # Lcom/squareup/okhttp3/internal/framed/FramedConnection;
    .param p1, "x1"    # I
    .param p2, "x2"    # Lcom/squareup/okio/BufferedSource;
    .param p3, "x3"    # I
    .param p4, "x4"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method static synthetic access$2500(Lcom/squareup/okhttp3/internal/framed/FramedConnection;ZIILcom/squareup/okhttp3/internal/framed/Ping;)V
    ...
    .param p2, "x2"    # I
    .param p3, "x3"    # I
    .param p4, "x4"    # Lcom/squareup/okhttp3/internal/framed/Ping;
...
.method private close(Lcom/squareup/okhttp3/internal/framed/ErrorCode;Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    .locals 12
    .param p1, "connectionCode"    # Lcom/squareup/okhttp3/internal/framed/ErrorCode;
    .param p2, "streamCode"    # Lcom/squareup/okhttp3/internal/framed/ErrorCode;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
    ...
    .prologue
    .line 427
    sget-boolean v10, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->$assertionsDisabled:Z
    ...
    .line 436
    .local v8, "streamsToClose":[Lcom/squareup/okhttp3/internal/framed/FramedStream;
    const/4 v6, 0x0

    .line 437
    .local v6, "pingsToCancel":[Lcom/squareup/okhttp3/internal/framed/Ping;
    monitor-enter p0

    .line 438
    :try_start_1
    iget-object v10, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->streams:Ljava/util/Map;
    ...
    iget-object v11, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->streams:Ljava/util/Map;

    invoke-interface {v11}, Ljava/util/Map;->size()I

    move-result v11

    new-array v11, v11, [Lcom/squareup/okhttp3/internal/framed/FramedStream;
    ...
    .line 442
    :cond_1
    iget-object v10, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->pings:Ljava/util/Map;
    ...
    iget-object v11, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->pings:Ljava/util/Map;

    invoke-interface {v11}, Ljava/util/Map;->size()I

    move-result v11

    new-array v11, v11, [Lcom/squareup/okhttp3/internal/framed/Ping;
    ...
    iput-object v10, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->pings:Ljava/util/Map;
    ...
    .local v1, "arr$":[Lcom/squareup/okhttp3/internal/framed/FramedStream;
    array-length v4, v1
    ...
    .line 451
    .local v7, "stream":Lcom/squareup/okhttp3/internal/framed/FramedStream;
    :try_start_2
    invoke-virtual {v7, p2}, Lcom/squareup/okhttp3/internal/framed/FramedStream;->close(Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    :try_end_2
    ...
    .line 431
    .end local v1    # "arr$":[Lcom/squareup/okhttp3/internal/framed/FramedStream;
    .end local v3    # "i$":I
    .end local v4    # "len$":I
    .end local v6    # "pingsToCancel":[Lcom/squareup/okhttp3/internal/framed/Ping;
    .end local v7    # "stream":Lcom/squareup/okhttp3/internal/framed/FramedStream;
    .end local v8    # "streamsToClose":[Lcom/squareup/okhttp3/internal/framed/FramedStream;
    :catch_0
    move-exception v2
    ...
    .restart local v6    # "pingsToCancel":[Lcom/squareup/okhttp3/internal/framed/Ping;
    .restart local v8    # "streamsToClose":[Lcom/squareup/okhttp3/internal/framed/FramedStream;
    :catchall_0
    move-exception v10
    ...
    .line 452
    .restart local v1    # "arr$":[Lcom/squareup/okhttp3/internal/framed/FramedStream;
    .restart local v3    # "i$":I
    .restart local v4    # "len$":I
    .restart local v7    # "stream":Lcom/squareup/okhttp3/internal/framed/FramedStream;
    :catch_1
    move-exception v2
    ...
    .local v1, "arr$":[Lcom/squareup/okhttp3/internal/framed/Ping;
    array-length v4, v1
    ...
    .line 460
    .local v5, "ping":Lcom/squareup/okhttp3/internal/framed/Ping;
    invoke-virtual {v5}, Lcom/squareup/okhttp3/internal/framed/Ping;->cancel()V
    ...
    .line 466
    .end local v1    # "arr$":[Lcom/squareup/okhttp3/internal/framed/Ping;
    .end local v3    # "i$":I
    .end local v4    # "len$":I
    .end local v5    # "ping":Lcom/squareup/okhttp3/internal/framed/Ping;
    :cond_5
    :try_start_4
    iget-object v10, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->frameWriter:Lcom/squareup/okhttp3/internal/framed/FrameWriter;

    invoke-interface {v10}, Lcom/squareup/okhttp3/internal/framed/FrameWriter;->close()V
    :try_end_4
    ...
    :goto_4
    :try_start_5
    iget-object v10, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->socket:Ljava/net/Socket;
...
.method private newStream(ILjava/util/List;ZZ)Lcom/squareup/okhttp3/internal/framed/FramedStream;
    ...
    .prologue
    .line 229
    .local p2, "requestHeaders":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/internal/framed/Header;>;"
    if-nez p3, :cond_0
    ...
    .line 237
    :try_start_1
    iget-boolean v2, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->shutdown:Z
    ...
    .line 241
    .local v1, "streamId":I
    iget v2, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->nextStreamId:I

    add-int/lit8 v2, v2, 0x2

    iput v2, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->nextStreamId:I
    ...
    invoke-interface {v2}, Lcom/squareup/okhttp3/internal/framed/FrameWriter;->flush()V
...
.method private writePing(ZIILcom/squareup/okhttp3/internal/framed/Ping;)V
    ...
    .param p2, "payload1"    # I
    .param p3, "payload2"    # I
    .param p4, "ping"    # Lcom/squareup/okhttp3/internal/framed/Ping;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public newStream(Ljava/util/List;ZZ)Lcom/squareup/okhttp3/internal/framed/FramedStream;
    ...
    .prologue
    .line 224
    .local p1, "requestHeaders":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/internal/framed/Header;>;"
    const/4 v0, 0x0
...
.method declared-synchronized removeStream(I)Lcom/squareup/okhttp3/internal/framed/FramedStream;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->streams:Ljava/util/Map;
    ...
    .line 191
    .end local v0    # "stream":Lcom/squareup/okhttp3/internal/framed/FramedStream;
    :catchall_0
    move-exception v1
...
.method public shutdown(Lcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    .locals 4
    .param p1, "statusCode"    # Lcom/squareup/okhttp3/internal/framed/ErrorCode;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
    ...
    :try_start_3
    iput-boolean v1, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->shutdown:Z
    ...
    invoke-interface {v1, v0, p1, v3}, Lcom/squareup/okhttp3/internal/framed/FrameWriter;->goAway(ILcom/squareup/okhttp3/internal/framed/ErrorCode;[B)V
...
.method start(Z)V
    ...
    invoke-interface {v1}, Lcom/squareup/okhttp3/internal/framed/FrameWriter;->connectionPreface()V

    .line 496
    iget-object v1, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->frameWriter:Lcom/squareup/okhttp3/internal/framed/FrameWriter;

    iget-object v2, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->okHttpSettings:Lcom/squareup/okhttp3/internal/framed/Settings;

    invoke-interface {v1, v2}, Lcom/squareup/okhttp3/internal/framed/FrameWriter;->settings(Lcom/squareup/okhttp3/internal/framed/Settings;)V
    ...
    invoke-virtual {v1, v3}, Lcom/squareup/okhttp3/internal/framed/Settings;->getInitialWindowSize(I)I
    ...
    iget-object v2, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->readerRunnable:Lcom/squareup/okhttp3/internal/framed/FramedConnection$Reader;
...
.method public writeData(IZLcom/squareup/okio/Buffer;J)V
    ...
    invoke-interface {v2, p2, p1, p3, v3}, Lcom/squareup/okhttp3/internal/framed/FrameWriter;->data(ZILcom/squareup/okio/Buffer;I)V
    ...
    .line 311
    iget-object v4, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->frameWriter:Lcom/squareup/okhttp3/internal/framed/FrameWriter;
    ...
    :goto_0
    invoke-interface {v4, v2, p1, p3, v1}, Lcom/squareup/okhttp3/internal/framed/FrameWriter;->data(ZILcom/squareup/okio/Buffer;I)V
...
.method writeSynReply(IZLjava/util/List;)V
    ...
    .prologue
    .line 267
    .local p3, "alternating":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/internal/framed/Header;>;"
    iget-object v0, p0, Lcom/squareup/okhttp3/internal/framed/FramedConnection;->frameWriter:Lcom/squareup/okhttp3/internal/framed/FrameWriter;
...
.method writeSynReset(ILcom/squareup/okhttp3/internal/framed/ErrorCode;)V
    .locals 1
    .param p1, "streamId"    # I
    .param p2, "statusCode"    # Lcom/squareup/okhttp3/internal/framed/ErrorCode;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
