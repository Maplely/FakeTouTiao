...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/squareup/okhttp3/Response$1;,
...
.method private constructor <init>(Lcom/squareup/okhttp3/Response$Builder;)V
    .locals 2
    .param p1, "builder"    # Lcom/squareup/okhttp3/Response$Builder;
...
.method synthetic constructor <init>(Lcom/squareup/okhttp3/Response$Builder;Lcom/squareup/okhttp3/Response$1;)V
    .locals 0
    .param p1, "x0"    # Lcom/squareup/okhttp3/Response$Builder;
    .param p2, "x1"    # Lcom/squareup/okhttp3/Response$1;
...
.method static synthetic access$1300(Lcom/squareup/okhttp3/Response;)Lcom/squareup/okhttp3/Request;
    .locals 1
    .param p0, "x0"    # Lcom/squareup/okhttp3/Response;
...
.method public cacheControl()Lcom/squareup/okhttp3/CacheControl;
    ...
    .line 246
    .local v0, "result":Lcom/squareup/okhttp3/CacheControl;
    if-eqz v0, :cond_0

    .end local v0    # "result":Lcom/squareup/okhttp3/CacheControl;
    :goto_0
    return-object v0

    .restart local v0    # "result":Lcom/squareup/okhttp3/CacheControl;
    :cond_0
    iget-object v1, p0, Lcom/squareup/okhttp3/Response;->headers:Lcom/squareup/okhttp3/Headers;

    invoke-static {v1}, Lcom/squareup/okhttp3/CacheControl;->parse(Lcom/squareup/okhttp3/Headers;)Lcom/squareup/okhttp3/CacheControl;
...
.method public header(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1}, Lcom/squareup/okhttp3/Headers;->get(Ljava/lang/String;)Ljava/lang/String;
...
.method public peekBody(J)Lcom/squareup/okhttp3/ResponseBody;
    ...
    .prologue
    .line 151
    iget-object v3, p0, Lcom/squareup/okhttp3/Response;->body:Lcom/squareup/okhttp3/ResponseBody;

    invoke-virtual {v3}, Lcom/squareup/okhttp3/ResponseBody;->source()Lcom/squareup/okio/BufferedSource;

    move-result-object v2

    .line 152
    .local v2, "source":Lcom/squareup/okio/BufferedSource;
    invoke-interface {v2, p1, p2}, Lcom/squareup/okio/BufferedSource;->request(J)Z
    ...
    invoke-virtual {v3}, Lcom/squareup/okio/Buffer;->clone()Lcom/squareup/okio/Buffer;

    move-result-object v0

    .line 157
    .local v0, "copy":Lcom/squareup/okio/Buffer;
    ...
    .line 159
    .local v1, "result":Lcom/squareup/okio/Buffer;
    invoke-virtual {v1, v0, p1, p2}, Lcom/squareup/okio/Buffer;->write(Lcom/squareup/okio/Buffer;J)V
    ...
    invoke-virtual {v3}, Lcom/squareup/okhttp3/ResponseBody;->contentType()Lcom/squareup/okhttp3/MediaType;
    ...
    invoke-static {v3, v4, v5, v1}, Lcom/squareup/okhttp3/ResponseBody;->create(Lcom/squareup/okhttp3/MediaType;JLcom/squareup/okio/BufferedSource;)Lcom/squareup/okhttp3/ResponseBody;
    ...
    .line 162
    .end local v1    # "result":Lcom/squareup/okio/Buffer;
    :cond_0
    move-object v1, v0

    .restart local v1    # "result":Lcom/squareup/okio/Buffer;
    goto :goto_0
.end method
