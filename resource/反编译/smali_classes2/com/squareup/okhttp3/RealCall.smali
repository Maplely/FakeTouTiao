.class final Lcom/squareup/okhttp3/RealCall;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/squareup/okhttp3/RealCall$1;,
...
.method protected constructor <init>(Lcom/squareup/okhttp3/OkHttpClient;Lcom/squareup/okhttp3/Request;)V
    ...
    .param p2, "originalRequest"    # Lcom/squareup/okhttp3/Request;
...
.method static synthetic access$100(Lcom/squareup/okhttp3/RealCall;)Lcom/squareup/okhttp3/Response;
    .locals 1
    .param p0, "x0"    # Lcom/squareup/okhttp3/RealCall;
...
.method private getResponseWithInterceptorChain()Lcom/squareup/okhttp3/Response;
    ...
    .line 163
    .local v1, "interceptors":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/Interceptor;>;"
    iget-object v3, p0, Lcom/squareup/okhttp3/RealCall;->client:Lcom/squareup/okhttp3/OkHttpClient;

    invoke-virtual {v3}, Lcom/squareup/okhttp3/OkHttpClient;->interceptors()Ljava/util/List;
    ...
    .line 165
    new-instance v3, Lcom/squareup/okhttp3/internal/http/BridgeInterceptor;

    iget-object v4, p0, Lcom/squareup/okhttp3/RealCall;->client:Lcom/squareup/okhttp3/OkHttpClient;

    invoke-virtual {v4}, Lcom/squareup/okhttp3/OkHttpClient;->cookieJar()Lcom/squareup/okhttp3/CookieJar;

    move-result-object v4

    invoke-direct {v3, v4}, Lcom/squareup/okhttp3/internal/http/BridgeInterceptor;-><init>(Lcom/squareup/okhttp3/CookieJar;)V

    invoke-interface {v1, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 166
    new-instance v3, Lcom/squareup/okhttp3/internal/cache/CacheInterceptor;

    iget-object v4, p0, Lcom/squareup/okhttp3/RealCall;->client:Lcom/squareup/okhttp3/OkHttpClient;

    invoke-virtual {v4}, Lcom/squareup/okhttp3/OkHttpClient;->internalCache()Lcom/squareup/okhttp3/internal/cache/InternalCache;

    move-result-object v4

    invoke-direct {v3, v4}, Lcom/squareup/okhttp3/internal/cache/CacheInterceptor;-><init>(Lcom/squareup/okhttp3/internal/cache/InternalCache;)V

    invoke-interface {v1, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 167
    new-instance v3, Lcom/squareup/okhttp3/internal/connection/ConnectInterceptor;

    iget-object v4, p0, Lcom/squareup/okhttp3/RealCall;->client:Lcom/squareup/okhttp3/OkHttpClient;

    invoke-direct {v3, v4}, Lcom/squareup/okhttp3/internal/connection/ConnectInterceptor;-><init>(Lcom/squareup/okhttp3/OkHttpClient;)V
    ...
    invoke-virtual {v3}, Lcom/squareup/okhttp3/OkHttpClient;->networkInterceptors()Ljava/util/List;
    ...
    .line 171
    :cond_0
    new-instance v3, Lcom/squareup/okhttp3/internal/http/CallServerInterceptor;

    iget-object v4, p0, Lcom/squareup/okhttp3/RealCall;->retryAndFollowUpInterceptor:Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;

    invoke-virtual {v4}, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->isForWebSocket()Z

    move-result v4

    invoke-direct {v3, v4}, Lcom/squareup/okhttp3/internal/http/CallServerInterceptor;-><init>(Z)V
    ...
    .line 176
    .local v0, "chain":Lcom/squareup/okhttp3/Interceptor$Chain;
    iget-object v2, p0, Lcom/squareup/okhttp3/RealCall;->originalRequest:Lcom/squareup/okhttp3/Request;

    invoke-interface {v0, v2}, Lcom/squareup/okhttp3/Interceptor$Chain;->proceed(Lcom/squareup/okhttp3/Request;)Lcom/squareup/okhttp3/Response;
...
.method private toLoggableString()Ljava/lang/String;
    ...
    .prologue
    .line 152
    iget-object v1, p0, Lcom/squareup/okhttp3/RealCall;->retryAndFollowUpInterceptor:Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;

    invoke-virtual {v1}, Lcom/squareup/okhttp3/internal/http/RetryAndFollowUpInterceptor;->isCanceled()Z
...
.method public enqueue(Lcom/squareup/okhttp3/Callback;)V
    .locals 3
    .param p1, "responseCallback"    # Lcom/squareup/okhttp3/Callback;
...
.method public execute()Lcom/squareup/okhttp3/Response;
    ...
    .line 55
    :try_start_0
    iget-boolean v1, p0, Lcom/squareup/okhttp3/RealCall;->executed:Z
    ...
    :try_start_1
    iput-boolean v1, p0, Lcom/squareup/okhttp3/RealCall;->executed:Z
    ...
    invoke-virtual {v1, p0}, Lcom/squareup/okhttp3/Dispatcher;->executed(Lcom/squareup/okhttp3/RealCall;)V
    ...
    .line 61
    .local v0, "result":Lcom/squareup/okhttp3/Response;
    if-nez v0, :cond_1
    ...
    .line 64
    .end local v0    # "result":Lcom/squareup/okhttp3/Response;
    :catchall_1
    move-exception v1

    iget-object v2, p0, Lcom/squareup/okhttp3/RealCall;->client:Lcom/squareup/okhttp3/OkHttpClient;

    invoke-virtual {v2}, Lcom/squareup/okhttp3/OkHttpClient;->dispatcher()Lcom/squareup/okhttp3/Dispatcher;

    move-result-object v2

    invoke-virtual {v2, p0}, Lcom/squareup/okhttp3/Dispatcher;->finished(Lcom/squareup/okhttp3/RealCall;)V

    throw v1

    .restart local v0    # "result":Lcom/squareup/okhttp3/Response;
    :cond_1
    iget-object v1, p0, Lcom/squareup/okhttp3/RealCall;->client:Lcom/squareup/okhttp3/OkHttpClient;
