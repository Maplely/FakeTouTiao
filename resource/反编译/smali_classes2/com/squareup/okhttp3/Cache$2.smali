.class Lcom/squareup/okhttp3/Cache$2;
...
.method public hasNext()Z
    ...
    .line 334
    iget-object v4, p0, Lcom/squareup/okhttp3/Cache$2;->nextUrl:Ljava/lang/String;
    ...
    .line 336
    :cond_0
    iput-boolean v3, p0, Lcom/squareup/okhttp3/Cache$2;->canRemove:Z

    .line 337
    :goto_1
    iget-object v4, p0, Lcom/squareup/okhttp3/Cache$2;->delegate:Ljava/util/Iterator;
    ...
    check-cast v1, Lcom/squareup/okhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    :try_start_0
    invoke-virtual {v1, v4}, Lcom/squareup/okhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lcom/squareup/okio/Source;

    move-result-object v4

    invoke-static {v4}, Lcom/squareup/okio/Okio;->buffer(Lcom/squareup/okio/Source;)Lcom/squareup/okio/BufferedSource;

    move-result-object v0

    .line 341
    .local v0, "metadata":Lcom/squareup/okio/BufferedSource;
    invoke-interface {v0}, Lcom/squareup/okio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;

    move-result-object v4

    iput-object v4, p0, Lcom/squareup/okhttp3/Cache$2;->nextUrl:Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 347
    invoke-virtual {v1}, Lcom/squareup/okhttp3/internal/cache/DiskLruCache$Snapshot;->close()V

    goto :goto_0

    .line 343
    .end local v0    # "metadata":Lcom/squareup/okio/BufferedSource;
    :catch_0
    move-exception v4
