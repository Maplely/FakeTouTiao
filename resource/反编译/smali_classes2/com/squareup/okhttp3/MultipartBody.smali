...
.method constructor <init>(Lcom/squareup/okio/ByteString;Lcom/squareup/okhttp3/MediaType;Ljava/util/List;)V
    .locals 2
    .param p1, "boundary"    # Lcom/squareup/okio/ByteString;
    .param p2, "type"    # Lcom/squareup/okhttp3/MediaType;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 73
    .local p3, "parts":Ljava/util/List;, "Ljava/util/List<Lcom/squareup/okhttp3/MultipartBody$Part;>;"
...
.method private writeOrCountBytes(Lcom/squareup/okio/BufferedSink;Z)J
    ...
    .line 126
    .local v3, "byteCountBuffer":Lcom/squareup/okio/Buffer;
    if-eqz p2, :cond_0

    .line 127
    new-instance v3, Lcom/squareup/okio/Buffer;

    .end local v3    # "byteCountBuffer":Lcom/squareup/okio/Buffer;
    invoke-direct {v3}, Lcom/squareup/okio/Buffer;-><init>()V

    .restart local v3    # "byteCountBuffer":Lcom/squareup/okio/Buffer;
    ...
    iget-object v15, v0, Lcom/squareup/okhttp3/MultipartBody;->parts:Ljava/util/List;
    ...
    check-cast v13, Lcom/squareup/okhttp3/MultipartBody$Part;

    .line 132
    .local v13, "part":Lcom/squareup/okhttp3/MultipartBody$Part;
    # getter for: Lcom/squareup/okhttp3/MultipartBody$Part;->headers:Lcom/squareup/okhttp3/Headers;
    invoke-static {v13}, Lcom/squareup/okhttp3/MultipartBody$Part;->access$000(Lcom/squareup/okhttp3/MultipartBody$Part;)Lcom/squareup/okhttp3/Headers;

    move-result-object v11

    .line 133
    .local v11, "headers":Lcom/squareup/okhttp3/Headers;
    # getter for: Lcom/squareup/okhttp3/MultipartBody$Part;->body:Lcom/squareup/okhttp3/RequestBody;
    invoke-static {v13}, Lcom/squareup/okhttp3/MultipartBody$Part;->access$100(Lcom/squareup/okhttp3/MultipartBody$Part;)Lcom/squareup/okhttp3/RequestBody;

    move-result-object v2

    .line 135
    .local v2, "body":Lcom/squareup/okhttp3/RequestBody;
    sget-object v15, Lcom/squareup/okhttp3/MultipartBody;->DASHDASH:[B

    move-object/from16 v0, p1

    invoke-interface {v0, v15}, Lcom/squareup/okio/BufferedSink;->write([B)Lcom/squareup/okio/BufferedSink;

    .line 136
    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/squareup/okhttp3/MultipartBody;->boundary:Lcom/squareup/okio/ByteString;

    move-object/from16 v0, p1

    invoke-interface {v0, v15}, Lcom/squareup/okio/BufferedSink;->write(Lcom/squareup/okio/ByteString;)Lcom/squareup/okio/BufferedSink;

    .line 137
    sget-object v15, Lcom/squareup/okhttp3/MultipartBody;->CRLF:[B
    ...
    .local v9, "h":I
    invoke-virtual {v11}, Lcom/squareup/okhttp3/Headers;->size()I
    ...
    .line 141
    invoke-virtual {v11, v9}, Lcom/squareup/okhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v15

    move-object/from16 v0, p1

    invoke-interface {v0, v15}, Lcom/squareup/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/squareup/okio/BufferedSink;

    move-result-object v15

    sget-object v16, Lcom/squareup/okhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface/range {v15 .. v16}, Lcom/squareup/okio/BufferedSink;->write([B)Lcom/squareup/okio/BufferedSink;

    move-result-object v15

    invoke-virtual {v11, v9}, Lcom/squareup/okhttp3/Headers;->value(I)Ljava/lang/String;

    move-result-object v16

    invoke-interface/range {v15 .. v16}, Lcom/squareup/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/squareup/okio/BufferedSink;

    move-result-object v15

    sget-object v16, Lcom/squareup/okhttp3/MultipartBody;->CRLF:[B
    ...
    .line 149
    .local v8, "contentType":Lcom/squareup/okhttp3/MediaType;
    if-eqz v8, :cond_2
    ...
    invoke-virtual {v8}, Lcom/squareup/okhttp3/MediaType;->toString()Ljava/lang/String;
    ...
    invoke-interface {v15, v6, v7}, Lcom/squareup/okio/BufferedSink;->writeDecimalLong(J)Lcom/squareup/okio/BufferedSink;
    ...
    .line 162
    invoke-virtual {v3}, Lcom/squareup/okio/Buffer;->clear()V

    .line 163
    const-wide/16 v16, -0x1

    .line 187
    .end local v2    # "body":Lcom/squareup/okhttp3/RequestBody;
    .end local v6    # "contentLength":J
    .end local v8    # "contentType":Lcom/squareup/okhttp3/MediaType;
    .end local v11    # "headers":Lcom/squareup/okhttp3/Headers;
    .end local v13    # "part":Lcom/squareup/okhttp3/MultipartBody$Part;
    :goto_3
    return-wide v16

    .line 171
    .restart local v2    # "body":Lcom/squareup/okhttp3/RequestBody;
    .restart local v6    # "contentLength":J
    .restart local v8    # "contentType":Lcom/squareup/okhttp3/MediaType;
    .restart local v11    # "headers":Lcom/squareup/okhttp3/Headers;
    .restart local v13    # "part":Lcom/squareup/okhttp3/MultipartBody$Part;
    :cond_5
    move-object/from16 v0, p1

    invoke-virtual {v2, v0}, Lcom/squareup/okhttp3/RequestBody;->writeTo(Lcom/squareup/okio/BufferedSink;)V
...
.method public contentLength()J
    ...
    invoke-direct {p0, v2, v3}, Lcom/squareup/okhttp3/MultipartBody;->writeOrCountBytes(Lcom/squareup/okio/BufferedSink;Z)J
