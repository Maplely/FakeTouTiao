...
.method public write(Lcom/ss/okio/Buffer;J)V
    ...
    .line 168
    iget-object v7, p1, Lcom/ss/okio/Buffer;->head:Lcom/ss/okio/Segment;

    iget v7, v7, Lcom/ss/okio/Segment;->limit:I

    iget-object v8, p1, Lcom/ss/okio/Buffer;->head:Lcom/ss/okio/Segment;

    iget v8, v8, Lcom/ss/okio/Segment;->pos:I
    ...
    .line 178
    iget-object v7, p0, Lcom/ss/okio/AsyncTimeout$1;->this$0:Lcom/ss/okio/AsyncTimeout;

    invoke-virtual {v7}, Lcom/ss/okio/AsyncTimeout;->enter()V

    .line 180
    :try_start_0
    iget-object v7, p0, Lcom/ss/okio/AsyncTimeout$1;->val$sink:Lcom/ss/okio/Sink;

    invoke-interface {v7, p1, v0, v1}, Lcom/ss/okio/Sink;->write(Lcom/ss/okio/Buffer;J)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 167
    :cond_1
    iget-object v0, v6, Lcom/ss/okio/Segment;->next:Lcom/ss/okio/Segment;
    ...
    invoke-virtual {v1, v0}, Lcom/ss/okio/AsyncTimeout;->exit(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-virtual {v1, v6}, Lcom/ss/okio/AsyncTimeout;->exit(Z)V
