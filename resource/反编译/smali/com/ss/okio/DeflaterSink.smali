.class public final Lcom/ss/okio/DeflaterSink;
...
# direct methods
.method constructor <init>(Lcom/ss/okio/BufferedSink;Ljava/util/zip/Deflater;)V
    .locals 2
    ...
    .line 55
    :cond_1
    iput-object p1, p0, Lcom/ss/okio/DeflaterSink;->sink:Lcom/ss/okio/BufferedSink;

    .line 56
    iput-object p2, p0, Lcom/ss/okio/DeflaterSink;->deflater:Ljava/util/zip/Deflater;

    .line 57
    return-void
.end method

.method public constructor <init>(Lcom/ss/okio/Sink;Ljava/util/zip/Deflater;)V
    .locals 1
    ...
    invoke-direct {p0, v0, p2}, Lcom/ss/okio/DeflaterSink;-><init>(Lcom/ss/okio/BufferedSink;Ljava/util/zip/Deflater;)V
...
.method private deflate(Z)V
    ...
    .prologue
    .line 84
    iget-object v0, p0, Lcom/ss/okio/DeflaterSink;->sink:Lcom/ss/okio/BufferedSink;
    ...
    invoke-virtual {v1, v0}, Lcom/ss/okio/Buffer;->writableSegment(I)Lcom/ss/okio/Segment;
    ...
    iget-object v0, p0, Lcom/ss/okio/DeflaterSink;->deflater:Ljava/util/zip/Deflater;

    iget-object v3, v2, Lcom/ss/okio/Segment;->data:[B

    iget v4, v2, Lcom/ss/okio/Segment;->limit:I

    iget v5, v2, Lcom/ss/okio/Segment;->limit:I
...
.method public close()V
    ...
    .prologue
    .line 122
    iget-boolean v0, p0, Lcom/ss/okio/DeflaterSink;->closed:Z
    ...
    .line 128
    :try_start_0
    invoke-virtual {p0}, Lcom/ss/okio/DeflaterSink;->finishDeflate()V
    :try_end_0
    ...
    :goto_2
    :try_start_2
    iget-object v1, p0, Lcom/ss/okio/DeflaterSink;->sink:Lcom/ss/okio/BufferedSink;
    ...
    iput-boolean v1, p0, Lcom/ss/okio/DeflaterSink;->closed:Z
...
.method finishDeflate()V
    ...
    invoke-direct {p0, v0}, Lcom/ss/okio/DeflaterSink;->deflate(Z)V
...
.method public write(Lcom/ss/okio/Buffer;J)V
    ...
    .line 65
    iget-object v4, p0, Lcom/ss/okio/DeflaterSink;->deflater:Ljava/util/zip/Deflater;
    ...
    invoke-direct {p0, v4}, Lcom/ss/okio/DeflaterSink;->deflate(Z)V
    ...
    iget v5, v0, Lcom/ss/okio/Segment;->limit:I
    ...
    iput-object v4, p1, Lcom/ss/okio/Buffer;->head:Lcom/ss/okio/Segment;
