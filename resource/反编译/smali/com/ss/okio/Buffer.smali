...
.method private rangeEquals(Lcom/ss/okio/Segment;ILcom/ss/okio/ByteString;II)Z
    .locals 6

    .prologue
    .line 1480
    iget v1, p1, Lcom/ss/okio/Segment;->limit:I
    ...
    .line 1485
    iget-object v3, v3, Lcom/ss/okio/Segment;->next:Lcom/ss/okio/Segment;

    .line 1486
    iget-object v0, v3, Lcom/ss/okio/Segment;->data:[B

    .line 1487
    iget v2, v3, Lcom/ss/okio/Segment;->pos:I

    .line 1488
    iget v1, v3, Lcom/ss/okio/Segment;->limit:I

    .line 1491
    :cond_0
    aget-byte v4, v0, v2

    invoke-virtual {p3, p4}, Lcom/ss/okio/ByteString;->getByte(I)B
...
.method public indexOf(BJ)J
    ...
    .line 1287
    iget-object v4, v4, Lcom/ss/okio/Segment;->prev:Lcom/ss/okio/Segment;

    .line 1288
    iget v2, v4, Lcom/ss/okio/Segment;->limit:I

    iget v3, v4, Lcom/ss/okio/Segment;->pos:I
    ...
    .line 1294
    iget-object v0, v4, Lcom/ss/okio/Segment;->next:Lcom/ss/okio/Segment;
    ...
    .line 1302
    iget-object v3, v4, Lcom/ss/okio/Segment;->data:[B
...
.method public indexOf(Lcom/ss/okio/ByteString;J)J
    ...
    .prologue
    .line 1323
    invoke-virtual/range {p1 .. p1}, Lcom/ss/okio/ByteString;->size()I
    ...
    iget-object v4, v0, Lcom/ss/okio/Buffer;->head:Lcom/ss/okio/Segment;
    ...
    .line 1340
    iget-object v6, v6, Lcom/ss/okio/Segment;->prev:Lcom/ss/okio/Segment;

    .line 1341
    iget v4, v6, Lcom/ss/okio/Segment;->limit:I

    iget v5, v6, Lcom/ss/okio/Segment;->pos:I
    ...
    .line 1347
    iget-object v2, v6, Lcom/ss/okio/Segment;->next:Lcom/ss/okio/Segment;
    ...
    invoke-virtual {v0, v4}, Lcom/ss/okio/ByteString;->getByte(I)B
    ...
    iget-wide v4, v0, Lcom/ss/okio/Buffer;->size:J
    ...
    .line 1360
    iget-object v14, v3, Lcom/ss/okio/Segment;->data:[B

    .line 1361
    iget v2, v3, Lcom/ss/okio/Segment;->limit:I
    ...
    invoke-direct/range {v2 .. v7}, Lcom/ss/okio/Buffer;->rangeEquals(Lcom/ss/okio/Segment;ILcom/ss/okio/ByteString;II)Z
    ...
    iget v4, v3, Lcom/ss/okio/Segment;->pos:I
...
.method public indexOfElement(Lcom/ss/okio/ByteString;J)J
    ...
    .line 1419
    iget-object v6, v4, Lcom/ss/okio/Segment;->data:[B
    ...
    iget v7, v4, Lcom/ss/okio/Segment;->limit:I
    ...
    iget v6, v4, Lcom/ss/okio/Segment;->pos:I
    ...
    .line 1434
    :cond_7
    invoke-virtual {p1}, Lcom/ss/okio/ByteString;->internalArray()[B
...
.method public md5()Lcom/ss/okio/ByteString;
    ...
    invoke-direct {p0, v0}, Lcom/ss/okio/Buffer;->digest(Ljava/lang/String;)Lcom/ss/okio/ByteString;
...
.method public rangeEquals(JLcom/ss/okio/ByteString;)Z
    .locals 7
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/ss/okio/Buffer;->rangeEquals(JLcom/ss/okio/ByteString;II)Z
...
.method public rangeEquals(JLcom/ss/okio/ByteString;II)Z
    .locals 7
    ...
    invoke-virtual {p0, v2, v3}, Lcom/ss/okio/Buffer;->getByte(J)B

    move-result v2

    add-int v3, p4, v1

    invoke-virtual {p3, v3}, Lcom/ss/okio/ByteString;->getByte(I)B
...
.method public select(Lcom/ss/okio/Options;)I
    .locals 14
    ...
    invoke-virtual {p1, v0}, Lcom/ss/okio/Options;->indexOf(Ljava/lang/Object;)I
    ...
    .line 536
    :cond_0
    iget-object v7, p1, Lcom/ss/okio/Options;->byteStrings:[Lcom/ss/okio/ByteString;
    ...
    .line 539
    iget-wide v10, p0, Lcom/ss/okio/Buffer;->size:J
    ...
    invoke-direct/range {v0 .. v5}, Lcom/ss/okio/Buffer;->rangeEquals(Lcom/ss/okio/Segment;ILcom/ss/okio/ByteString;II)Z
...
.method selectPrefix(Lcom/ss/okio/Options;)I
    .locals 14
...
.method public sha1()Lcom/ss/okio/ByteString;
    .locals 1
...
.method public toString()Ljava/lang/String;
    ...
    .prologue
    .line 1602
    invoke-virtual {p0}, Lcom/ss/okio/Buffer;->snapshot()Lcom/ss/okio/ByteString;
