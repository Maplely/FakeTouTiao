...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;JLcom/ss/android/model/h;JLjava/util/List;I)V
    .locals 8
    ...
    invoke-direct {p0, v2}, Lcom/ss/android/common/AbsApiThread;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct/range {v2 .. v7}, Lcom/ss/android/account/model/a;-><init>(Ljava/lang/String;JLcom/ss/android/model/h;Ljava/util/List;)V
...
.method private static a(Lcom/ss/android/account/model/a;Landroid/content/Context;I)Z
    ...
    invoke-direct {v2, v5, v6}, Lcom/ss/android/http/legacy/b/e;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/ss/android/account/model/a;->c:Lcom/ss/android/model/h;

    iget-wide v6, v6, Lcom/ss/android/model/h;->mGroupId:J
    ...
    iget v6, v6, Lcom/ss/android/model/h;->mAggrType:I
    ...
    .line 131
    iget-object v2, p0, Lcom/ss/android/account/model/a;->c:Lcom/ss/android/model/h;

    invoke-virtual {v2}, Lcom/ss/android/model/h;->getTag()Ljava/lang/String;
    ...
    .line 133
    new-instance v5, Lcom/ss/android/http/legacy/b/e;

    const-string v6, "tag"

    invoke-direct {v5, v6, v2}, Lcom/ss/android/http/legacy/b/e;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6, v3}, Lcom/ss/android/common/util/NetworkUtils;->executePost(ILjava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    .line 148
    invoke-static {v5}, Lcom/ss/android/account/a/i;->isApiSuccess(Lorg/json/JSONObject;)Z
