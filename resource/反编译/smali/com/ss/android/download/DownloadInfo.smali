...
.field private G:Lcom/ss/android/download/s;

.field private final H:Landroid/content/Context;

.field private I:Landroid/app/NotificationManager;

.field private final J:Lcom/ss/android/download/ab;

.field private final K:Lcom/ss/android/download/z;

.field private final L:Lcom/ss/android/download/h;
...
# direct methods
.method private constructor <init>(Landroid/content/Context;Lcom/ss/android/download/ab;Lcom/ss/android/download/z;Lcom/ss/android/download/h;)V
    .locals 2
    ...
    .line 245
    iput-object p2, p0, Lcom/ss/android/download/DownloadInfo;->J:Lcom/ss/android/download/ab;

    .line 246
    iput-object p3, p0, Lcom/ss/android/download/DownloadInfo;->K:Lcom/ss/android/download/z;

    .line 247
    iput-object p4, p0, Lcom/ss/android/download/DownloadInfo;->L:Lcom/ss/android/download/h;
...
.method synthetic constructor <init>(Landroid/content/Context;Lcom/ss/android/download/ab;Lcom/ss/android/download/z;Lcom/ss/android/download/h;Lcom/ss/android/download/e;)V
    .locals 0

    .prologue
    .line 34
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/ss/android/download/DownloadInfo;-><init>(Landroid/content/Context;Lcom/ss/android/download/ab;Lcom/ss/android/download/z;Lcom/ss/android/download/h;)V

    return-void
.end method

.method public static a(Lcom/ss/android/download/n;J)I
    .locals 7
...
.method private d(I)Lcom/ss/android/download/DownloadInfo$NetworkState;
    ...
    .line 400
    :cond_1
    iget-object v0, p0, Lcom/ss/android/download/DownloadInfo;->J:Lcom/ss/android/download/ab;

    invoke-interface {v0}, Lcom/ss/android/download/ab;->d()Ljava/lang/Long;
    ...
    invoke-interface {v0}, Lcom/ss/android/download/ab;->e()Ljava/lang/Long;
...
.method private f()Z
    ...
    .line 306
    :sswitch_3
    iget-object v2, p0, Lcom/ss/android/download/DownloadInfo;->J:Lcom/ss/android/download/ab;
...
.method private h()Z
    ...
    .line 384
    iget-object v1, p0, Lcom/ss/android/download/DownloadInfo;->J:Lcom/ss/android/download/ab;
...
.method public a(I)V
    ...
    invoke-interface {v1, v0}, Lcom/ss/android/download/ab;->a(Landroid/content/Intent;)V
...
.method public a(Lcom/ss/android/download/p;)Z
    .locals 1
    ...
    .line 451
    invoke-virtual {p1, p0}, Lcom/ss/android/download/p;->a(Lcom/ss/android/download/DownloadInfo;)V
...
.method public a(Ljava/util/concurrent/ExecutorService;)Z
    ...
    .line 433
    :cond_0
    new-instance v0, Lcom/ss/android/download/s;

    iget-object v1, p0, Lcom/ss/android/download/DownloadInfo;->H:Landroid/content/Context;

    iget-object v2, p0, Lcom/ss/android/download/DownloadInfo;->J:Lcom/ss/android/download/ab;

    iget-object v4, p0, Lcom/ss/android/download/DownloadInfo;->K:Lcom/ss/android/download/z;

    iget-object v5, p0, Lcom/ss/android/download/DownloadInfo;->L:Lcom/ss/android/download/h;

    move-object v3, p0

    invoke-direct/range {v0 .. v5}, Lcom/ss/android/download/s;-><init>(Landroid/content/Context;Lcom/ss/android/download/ab;Lcom/ss/android/download/DownloadInfo;Lcom/ss/android/download/z;Lcom/ss/android/download/h;)V

    iput-object v0, p0, Lcom/ss/android/download/DownloadInfo;->G:Lcom/ss/android/download/s;

    .line 435
    iget-object v0, p0, Lcom/ss/android/download/DownloadInfo;->G:Lcom/ss/android/download/s;
...
.method public b()Lcom/ss/android/download/DownloadInfo$NetworkState;
    ...
    invoke-interface {v1}, Lcom/ss/android/download/ab;->c()Z
...
.method public c()V
    ...
    .line 463
    invoke-static {p0}, Lcom/ss/android/download/h;->b(Lcom/ss/android/download/DownloadInfo;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Lcom/ss/android/download/h;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v3, v3}, Lcom/ss/android/download/n;->a(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
