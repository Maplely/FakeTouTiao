...
# instance fields
.field private a:Lcom/ss/android/common/download/IAlertDialog;
...
.method private a()V
    ...
    .line 54
    iget-object v0, p0, Lcom/ss/android/download/SizeLimitActivity;->a:Lcom/ss/android/common/download/IAlertDialog;
...
.method private a(Landroid/database/Cursor;)V
    ...
    .line 98
    invoke-static {p0}, Lcom/ss/android/download/t;->b(Landroid/content/Context;)Lcom/ss/android/common/download/IAlertDialogBuilder;
    ...
    invoke-interface {v3, v2}, Lcom/ss/android/common/download/IAlertDialogBuilder;->setTitle(I)Lcom/ss/android/common/download/IAlertDialogBuilder;
    ...
    invoke-interface {v2, v0}, Lcom/ss/android/common/download/IAlertDialogBuilder;->setMessage(Ljava/lang/String;)Lcom/ss/android/common/download/IAlertDialogBuilder;
    ...
    .line 102
    invoke-interface {v0, v1, p0}, Lcom/ss/android/common/download/IAlertDialogBuilder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Lcom/ss/android/common/download/IAlertDialogBuilder;
    ...
    .line 103
    invoke-interface {v0, v1, p0}, Lcom/ss/android/common/download/IAlertDialogBuilder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Lcom/ss/android/common/download/IAlertDialogBuilder;

    .line 110
    :goto_0
    new-instance v0, Lcom/ss/android/download/y;

    invoke-direct {v0, p0}, Lcom/ss/android/download/y;-><init>(Lcom/ss/android/download/SizeLimitActivity;)V

    invoke-interface {v3, v0}, Lcom/ss/android/common/download/IAlertDialogBuilder;->setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)Lcom/ss/android/common/download/IAlertDialogBuilder;

    move-result-object v0

    .line 115
    invoke-interface {v0}, Lcom/ss/android/common/download/IAlertDialogBuilder;->show()Lcom/ss/android/common/download/IAlertDialog;

    move-result-object v0

    iput-object v0, p0, Lcom/ss/android/download/SizeLimitActivity;->a:Lcom/ss/android/common/download/IAlertDialog;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-interface {v1}, Lcom/ss/android/download/v;->a()I
    ...
    invoke-interface {v0}, Lcom/ss/android/download/v;->b()I
    ...
    invoke-virtual {v1, v2, v0, v3, v3}, Lcom/ss/android/download/n;->a(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
...
.method protected onResume()V
    ...
    invoke-interface {v0}, Lcom/ss/android/common/download/IAlertDialog;->isShowing()Z
    ...
    invoke-interface {v0}, Lcom/ss/android/common/download/IAlertDialog;->show()V
