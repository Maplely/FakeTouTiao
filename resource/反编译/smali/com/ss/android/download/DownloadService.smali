...
.field private c:Lcom/ss/android/download/z;

.field private d:Lcom/ss/android/download/DownloadService$a;

.field private e:Lcom/ss/android/download/h;
...
.field private h:Lcom/ss/android/download/p;
...
.method public constructor <init>()V
    ...
    .line 246
    new-instance v0, Lcom/ss/android/download/q;

    invoke-direct {v0, p0}, Lcom/ss/android/download/q;-><init>(Lcom/ss/android/download/DownloadService;)V
...
.method private a(Lcom/ss/android/download/DownloadInfo$a;J)Lcom/ss/android/download/DownloadInfo;
    ...
    .prologue
    .line 436
    iget-object v0, p0, Lcom/ss/android/download/DownloadService;->a:Lcom/ss/android/download/ab;

    iget-object v1, p0, Lcom/ss/android/download/DownloadService;->c:Lcom/ss/android/download/z;

    iget-object v2, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/h;

    invoke-virtual {p1, p0, v0, v1, v2}, Lcom/ss/android/download/DownloadInfo$a;->a(Landroid/content/Context;Lcom/ss/android/download/ab;Lcom/ss/android/download/z;Lcom/ss/android/download/h;)Lcom/ss/android/download/DownloadInfo;
...
.method private a(J)V
    ...
    .line 472
    :cond_2
    iget-object v1, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/h;

    invoke-static {v0}, Lcom/ss/android/download/h;->b(Lcom/ss/android/download/DownloadInfo;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/ss/android/download/h;->a(Ljava/lang/String;)V
...
.method static synthetic d(Lcom/ss/android/download/DownloadService;)Lcom/ss/android/download/h;
    .locals 1

    .prologue
    .line 56
    iget-object v0, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/h;
...
.method private d()Z
    ...
    iget-object v2, v0, Lcom/ss/android/download/DownloadService;->a:Lcom/ss/android/download/ab;
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/ss/android/download/n;->a(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {v14, v2, v7}, Lcom/ss/android/download/DownloadInfo$a;-><init>(Lcom/ss/android/download/n;Landroid/database/Cursor;)V
    ...
    invoke-virtual {v2, v8, v9, v10}, Lcom/ss/android/download/n;->a(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I

    .line 362
    move-object/from16 v0, p0

    iget-object v8, v0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/h;

    invoke-virtual {v8, v3}, Lcom/ss/android/download/h;->a(Lcom/ss/android/download/DownloadInfo;)V
    ...
    invoke-static {v3}, Lcom/ss/android/download/h;->b(Lcom/ss/android/download/DownloadInfo;)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v8, v9}, Lcom/ss/android/download/h;->a(Ljava/lang/String;)V
    ...
    iget-object v9, v0, Lcom/ss/android/download/DownloadService;->h:Lcom/ss/android/download/p;

    invoke-virtual {v3, v9}, Lcom/ss/android/download/DownloadInfo;->a(Lcom/ss/android/download/p;)Z
    :try_end_1
    ...
    iget-object v2, v0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/h;
    ...
    invoke-virtual {v2, v6}, Lcom/ss/android/download/h;->a(Ljava/util/Collection;)V
    ...
    .line 416
    invoke-static {}, Lcom/ss/android/download/t;->d()Z
    ...
    .line 420
    invoke-static {v7, v2, v4, v5, v6}, Lcom/bytedance/common/b/k;->a(Landroid/app/AlarmManager;IJLandroid/app/PendingIntent;)V
    :try_end_6
...
.method static synthetic g(Lcom/ss/android/download/DownloadService;)Lcom/ss/android/download/p;
    .locals 1

    .prologue
    .line 56
    iget-object v0, p0, Lcom/ss/android/download/DownloadService;->h:Lcom/ss/android/download/p;
...
.method public onCreate()V
    ...
    invoke-static {v0}, Lcom/ss/android/download/t;->a(Landroid/content/Context;)Z
    ...
    .line 159
    invoke-static {p0}, Lcom/ss/android/download/x;->a(Landroid/content/Context;)Lcom/ss/android/download/x;

    move-result-object v0

    iput-object v0, p0, Lcom/ss/android/download/DownloadService;->a:Lcom/ss/android/download/ab;
    ...
    .line 163
    new-instance v0, Lcom/ss/android/download/z;

    invoke-direct {v0, p0}, Lcom/ss/android/download/z;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ss/android/download/DownloadService;->c:Lcom/ss/android/download/z;
    ...
    invoke-direct {v0, p0}, Lcom/ss/android/download/p;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ss/android/download/DownloadService;->h:Lcom/ss/android/download/p;

    .line 171
    invoke-static {p0}, Lcom/ss/android/download/h;->a(Landroid/content/Context;)Lcom/ss/android/download/h;

    move-result-object v0

    iput-object v0, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/h;

    .line 172
    iget-object v0, p0, Lcom/ss/android/download/DownloadService;->e:Lcom/ss/android/download/h;

    invoke-virtual {v0}, Lcom/ss/android/download/h;->a()V
...
.method public onDestroy()V
    ...
    invoke-virtual {v0}, Lcom/ss/android/download/p;->a()V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-static {v1}, Lcom/ss/android/download/t;->a(Landroid/content/Context;)Z
