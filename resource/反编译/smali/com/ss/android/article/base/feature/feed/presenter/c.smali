...
.method private a(ILcom/bytedance/article/common/model/detail/a;J)V
    .locals 13
    ...
    invoke-virtual {v0, p1, v10, v11, p2}, Lcom/ss/android/action/b;->a(IJLcom/ss/android/model/h;)V

    .line 48
    iget-wide v0, p2, Lcom/bytedance/article/common/model/detail/a;->mSubjectGroupId:J
    ...
    iget-wide v2, p2, Lcom/bytedance/article/common/model/detail/a;->mSubjectGroupId:J
    ...
    :goto_0
    iput-boolean v0, v1, Lcom/bytedance/article/common/model/detail/a;->mUserDislike:Z
    ...
    invoke-virtual {v0, p1, v10, v11, v1}, Lcom/ss/android/action/b;->a(IJLcom/ss/android/model/h;)V
    ...
    invoke-direct/range {v0 .. v9}, Lcom/ss/android/article/base/feature/feed/presenter/d;-><init>(Landroid/content/Context;Landroid/os/Handler;IJLcom/bytedance/article/common/model/detail/a;JI)V

    .line 55
    invoke-virtual {v0}, Lcom/ss/android/article/base/feature/feed/presenter/d;->start()V
...
.method public a(ILcom/ss/android/model/h;J)V
    ...
    .line 31
    :cond_0
    instance-of v0, p2, Lcom/bytedance/article/common/model/detail/a;
    ...
    .line 33
    iget v2, v0, Lcom/bytedance/article/common/model/detail/a;->mGroupType:I
    ...
    .line 39
    invoke-direct {p0, p1, v0, p3, p4}, Lcom/ss/android/article/base/feature/feed/presenter/c;->a(ILcom/bytedance/article/common/model/detail/a;J)V
    ...
    .line 41
    :cond_1
    invoke-super {p0, p1, p2, p3, p4}, Lcom/ss/android/action/g;->a(ILcom/ss/android/model/h;J)V
...
.method public handleMsg(Landroid/os/Message;)V
    ...
    .line 68
    invoke-super {p0, p1}, Lcom/ss/android/action/g;->handleMsg(Landroid/os/Message;)V
    ...
    .line 79
    iget-object v0, v6, Lcom/ss/android/article/base/feature/feed/presenter/d$a;->g:Lcom/bytedance/article/common/model/detail/a;
    ...
    iget-object v4, v6, Lcom/ss/android/article/base/feature/feed/presenter/d$a;->g:Lcom/bytedance/article/common/model/detail/a;
    ...
    .line 83
    new-instance v7, Lcom/bytedance/article/common/model/detail/a;

    iget-wide v8, v6, Lcom/ss/android/article/base/feature/feed/presenter/d$a;->e:J

    move v12, v5

    invoke-direct/range {v7 .. v12}, Lcom/bytedance/article/common/model/detail/a;-><init>(JJI)V
    ...
    :goto_2
    iput-boolean v0, v7, Lcom/bytedance/article/common/model/detail/a;->mUserDislike:Z
