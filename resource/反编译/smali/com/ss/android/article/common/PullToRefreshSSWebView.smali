...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/ss/android/article/common/PullToRefreshSSWebView$InternalWebViewSDK9;
    }
.end annotation
...
# static fields
.field private static final defaultOnRefreshListener:Lcom/handmark/pulltorefresh/library/PullToRefreshBase$e;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final defaultWebViewClient:Landroid/webkit/WebViewClient;

.field protected mIsReadyForPullStart:Z
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 22
    new-instance v0, Lcom/ss/android/article/common/PullToRefreshSSWebView$1;

    invoke-direct {v0}, Lcom/ss/android/article/common/PullToRefreshSSWebView$1;-><init>()V

    sput-object v0, Lcom/ss/android/article/common/PullToRefreshSSWebView;->defaultOnRefreshListener:Lcom/handmark/pulltorefresh/library/PullToRefreshBase$e;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 29
    new-instance v0, Lcom/ss/android/article/common/PullToRefreshSSWebView$2;

    invoke-direct {v0, p0}, Lcom/ss/android/article/common/PullToRefreshSSWebView$2;-><init>(Lcom/ss/android/article/common/PullToRefreshSSWebView;)V

    iput-object v0, p0, Lcom/ss/android/article/common/PullToRefreshSSWebView;->defaultWebChromeClient:Landroid/webkit/WebChromeClient;
    ...
    iput-object v0, p0, Lcom/ss/android/article/common/PullToRefreshSSWebView;->defaultWebViewClient:Landroid/webkit/WebViewClient;

    .line 50
    invoke-direct {p0}, Lcom/ss/android/article/common/PullToRefreshSSWebView;->init()V
...
.method private init()V
    ...
    .prologue
    .line 43
    sget-object v0, Lcom/ss/android/article/common/PullToRefreshSSWebView;->defaultOnRefreshListener:Lcom/handmark/pulltorefresh/library/PullToRefreshBase$e;
    ...
    iget-object v1, p0, Lcom/ss/android/article/common/PullToRefreshSSWebView;->defaultWebChromeClient:Landroid/webkit/WebChromeClient;
    ...
    iget-object v1, p0, Lcom/ss/android/article/common/PullToRefreshSSWebView;->defaultWebViewClient:Landroid/webkit/WebViewClient;
...
.method protected bridge synthetic createRefreshableView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .prologue
    .line 21
    invoke-virtual {p0, p1, p2}, Lcom/ss/android/article/common/PullToRefreshSSWebView;->createRefreshableView(Landroid/content/Context;Landroid/util/AttributeSet;)Lcom/ss/android/newmedia/webview/SSWebView;
...
.method protected createRefreshableView(Landroid/content/Context;Landroid/util/AttributeSet;)Lcom/ss/android/newmedia/webview/SSWebView;
    .locals 2
    ...
    .line 77
    new-instance v0, Lcom/ss/android/article/common/PullToRefreshSSWebView$InternalWebViewSDK9;

    invoke-direct {v0, p0, p1, p2}, Lcom/ss/android/article/common/PullToRefreshSSWebView$InternalWebViewSDK9;-><init>(Lcom/ss/android/article/common/PullToRefreshSSWebView;Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected isReadyForPullStart()Z
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/ss/android/article/common/PullToRefreshSSWebView;->mIsReadyForPullStart:Z

    .line 96
    iget-boolean v0, p0, Lcom/ss/android/article/common/PullToRefreshSSWebView;->mIsReadyForPullStart:Z
