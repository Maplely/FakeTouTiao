.class public Lcom/ss/android/newmedia/e/v;
...
.field final b:Lcom/ss/android/common/app/IComponent;
...
.field final f:Lcom/bytedance/common/utility/collection/f;

.field g:Lcom/ss/android/model/h;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/ss/android/common/app/IComponent;Lcom/ss/android/newmedia/b;Z)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/ss/android/newmedia/e/v;->f:Lcom/bytedance/common/utility/collection/f;

    .line 45
    iput-object p1, p0, Lcom/ss/android/newmedia/e/v;->a:Landroid/content/Context;

    .line 46
    iput-object p2, p0, Lcom/ss/android/newmedia/e/v;->b:Lcom/ss/android/common/app/IComponent;

    .line 47
    iput-object p3, p0, Lcom/ss/android/newmedia/e/v;->c:Lcom/ss/android/newmedia/b;

    .line 48
    iput-boolean p4, p0, Lcom/ss/android/newmedia/e/v;->i:Z
    ...
    iput-object v0, p0, Lcom/ss/android/newmedia/e/v;->d:Lcom/ss/android/account/e;

    .line 50
    iget-object v0, p0, Lcom/ss/android/newmedia/e/v;->d:Lcom/ss/android/account/e;

    invoke-virtual {v0}, Lcom/ss/android/account/e;->b()[Lcom/ss/android/account/model/c;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/ss/android/newmedia/e/v;->a([Lcom/ss/android/account/model/c;)V
...
.method public static a(Landroid/content/Context;)V
    ...
    new-instance v2, Lcom/ss/android/newmedia/e/y;

    invoke-direct {v2, p0}, Lcom/ss/android/newmedia/e/y;-><init>(Landroid/content/Context;)V
...
.method private a([Lcom/ss/android/account/model/c;)V
    ...
    iput-object v0, p0, Lcom/ss/android/newmedia/e/v;->e:[Lcom/ss/android/account/model/c;

    .line 62
    iget-object v0, p0, Lcom/ss/android/newmedia/e/v;->e:[Lcom/ss/android/account/model/c;
...
.method a()Ljava/util/ArrayList;
    ...
    .line 304
    iget-object v2, p0, Lcom/ss/android/newmedia/e/v;->e:[Lcom/ss/android/account/model/c;
    ...
    iget-object v6, v4, Lcom/ss/android/account/model/c;->l:Ljava/lang/String;
    ...
    .line 306
    iget-object v5, p0, Lcom/ss/android/newmedia/e/v;->a:Landroid/content/Context;

    iget v4, v4, Lcom/ss/android/account/model/c;->m:I
...
.method a(II)V
    ...
    .prologue
    .line 242
    iget-object v0, p0, Lcom/ss/android/newmedia/e/v;->a:Landroid/content/Context;
...
.method a(Landroid/os/Message;Z)V
    ...
    .line 298
    :goto_0
    iget-object v1, p0, Lcom/ss/android/newmedia/e/v;->b:Lcom/ss/android/common/app/IComponent;

    invoke-interface {v1}, Lcom/ss/android/common/app/IComponent;->isActive()Z
    ...
    invoke-virtual {p0, v1, v0}, Lcom/ss/android/newmedia/e/v;->a(II)V
    ...
    iget-object v1, p0, Lcom/ss/android/newmedia/e/v;->a:Landroid/content/Context;
    ...
    .line 280
    iget-object v1, p0, Lcom/ss/android/newmedia/e/v;->d:Lcom/ss/android/account/e;

    iget-object v0, p1, Landroid/os/Message;->obj:Ljava/lang/Object;

    check-cast v0, Ljava/lang/String;

    iget-object v2, p0, Lcom/ss/android/newmedia/e/v;->a:Landroid/content/Context;
...
.method public a(Lcom/ss/android/model/h;)V
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/ss/android/newmedia/e/v;->a(Lcom/ss/android/model/h;J)V
...
.method a(Lcom/ss/android/model/h;JZZ)V
    .locals 4
    ...
    .line 178
    invoke-virtual/range {p0 .. p5}, Lcom/ss/android/newmedia/e/v;->b(Lcom/ss/android/model/h;JZZ)V
    ...
    .line 180
    :cond_1
    iput-object p1, p0, Lcom/ss/android/newmedia/e/v;->g:Lcom/ss/android/model/h;

    .line 181
    iput-wide p2, p0, Lcom/ss/android/newmedia/e/v;->h:J
    ...
    .line 189
    :goto_1
    iget-object v0, p0, Lcom/ss/android/newmedia/e/v;->b:Lcom/ss/android/common/app/IComponent;
    ...
    invoke-interface {v0, v2, v1}, Lcom/ss/android/common/app/IComponent;->startActivityForResult(Landroid/content/Intent;I)V
...
.method a(Z)V
    ...
    invoke-interface {v0}, Lcom/ss/android/common/app/IComponent;->isActive()Z
    ...
    .line 315
    :cond_1
    invoke-virtual {p0}, Lcom/ss/android/newmedia/e/v;->a()Ljava/util/ArrayList;
    ...
    iget-boolean v0, p0, Lcom/ss/android/newmedia/e/v;->i:Z
...
.method public a(I)Z
    ...
    .line 121
    iget-object v0, p0, Lcom/ss/android/newmedia/e/v;->g:Lcom/ss/android/model/h;
    ...
    .line 124
    iget-object v1, p0, Lcom/ss/android/newmedia/e/v;->g:Lcom/ss/android/model/h;

    iget-wide v2, p0, Lcom/ss/android/newmedia/e/v;->h:J

    move-object v0, p0

    move v5, v4

    invoke-virtual/range {v0 .. v5}, Lcom/ss/android/newmedia/e/v;->b(Lcom/ss/android/model/h;JZZ)V
    ...
    .line 127
    iget-object v7, p0, Lcom/ss/android/newmedia/e/v;->g:Lcom/ss/android/model/h;

    iget-wide v8, p0, Lcom/ss/android/newmedia/e/v;->h:J

    move-object v6, p0

    move v11, v4

    invoke-virtual/range {v6 .. v11}, Lcom/ss/android/newmedia/e/v;->b(Lcom/ss/android/model/h;JZZ)V
...
.method public a(Lcom/ss/android/model/h;JZ)Z
    .locals 6
    ...
    .line 92
    :cond_1
    iget-object v0, p0, Lcom/ss/android/newmedia/e/v;->c:Lcom/ss/android/newmedia/b;
    ...
    .line 98
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Lcom/ss/android/newmedia/e/v;->c(Lcom/ss/android/model/h;J)V
    ...
    invoke-virtual {v0}, Lcom/ss/android/newmedia/b;->dI()Z
    ...
    invoke-virtual {v0, v4}, Lcom/ss/android/newmedia/b;->a(Z)V

    .line 105
    iget-object v0, p0, Lcom/ss/android/newmedia/e/v;->a:Landroid/content/Context;

    invoke-static {v0}, Lcom/ss/android/newmedia/e/v;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v1, v4}, Lcom/ss/android/newmedia/b;->g(Landroid/content/Context;Z)V
...
.method b(Lcom/ss/android/model/h;JZZ)V
    .locals 14
    ...
    invoke-virtual {p0, v0, v1}, Lcom/ss/android/newmedia/e/v;->a(II)V
    ...
    iget-object v2, p0, Lcom/ss/android/newmedia/e/v;->f:Lcom/bytedance/common/utility/collection/f;
...
.method public b(Lcom/ss/android/model/h;)Z
    .locals 3
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lcom/ss/android/newmedia/e/v;->a(Lcom/ss/android/model/h;JZ)Z
...
.method public b(Lcom/ss/android/model/h;J)Z
    .locals 2
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/ss/android/newmedia/e/v;->a(Lcom/ss/android/model/h;JZ)Z
...
.method c(Lcom/ss/android/model/h;J)V
    .locals 4
    ...
    new-instance v2, Lcom/ss/android/newmedia/e/w;

    invoke-direct {v2, p0, p1, p2, p3}, Lcom/ss/android/newmedia/e/w;-><init>(Lcom/ss/android/newmedia/e/v;Lcom/ss/android/model/h;J)V
    ...
    new-instance v2, Lcom/ss/android/newmedia/e/x;

    invoke-direct {v2, p0}, Lcom/ss/android/newmedia/e/x;-><init>(Lcom/ss/android/newmedia/e/v;)V
...
.method public handleMsg(Landroid/os/Message;)V
    ...
    .line 253
    invoke-virtual {p0, v0}, Lcom/ss/android/newmedia/e/v;->a(Z)V
    ...
    iget-object v0, v0, Lcom/ss/android/action/a/a/a;->w:Ljava/lang/String;
    ...
    .line 263
    :pswitch_1
    invoke-virtual {p0, p1, v0}, Lcom/ss/android/newmedia/e/v;->a(Landroid/os/Message;Z)V
