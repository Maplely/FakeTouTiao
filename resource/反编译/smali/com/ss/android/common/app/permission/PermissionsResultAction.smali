.class public abstract Lcom/ss/android/common/app/permission/PermissionsResultAction;
...
.method protected final declared-synchronized onResult(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0, p1, v0}, Lcom/ss/android/common/app/permission/PermissionsResultAction;->onResult(Ljava/lang/String;Lcom/ss/android/common/app/permission/Permissions;)Z
    :try_end_0
...
.method protected final declared-synchronized onResult(Ljava/lang/String;Lcom/ss/android/common/app/permission/Permissions;)Z
    .locals 3
    .param p1    # Ljava/lang/String;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    :try_start_0
    iget-object v1, p0, Lcom/ss/android/common/app/permission/PermissionsResultAction;->mPermissions:Ljava/util/Set;
    ...
    iget-object v2, p0, Lcom/ss/android/common/app/permission/PermissionsResultAction;->mLooper:Landroid/os/Looper;

    invoke-direct {v1, v2}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V

    new-instance v2, Lcom/ss/android/common/app/permission/PermissionsResultAction$1;

    invoke-direct {v2, p0}, Lcom/ss/android/common/app/permission/PermissionsResultAction$1;-><init>(Lcom/ss/android/common/app/permission/PermissionsResultAction;)V
    ...
    new-instance v2, Lcom/ss/android/common/app/permission/PermissionsResultAction$2;

    invoke-direct {v2, p0, p1}, Lcom/ss/android/common/app/permission/PermissionsResultAction$2;-><init>(Lcom/ss/android/common/app/permission/PermissionsResultAction;Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/ss/android/common/app/permission/PermissionsResultAction$3;

    invoke-direct {v2, p0}, Lcom/ss/android/common/app/permission/PermissionsResultAction$3;-><init>(Lcom/ss/android/common/app/permission/PermissionsResultAction;)V
    ...
    new-instance v2, Lcom/ss/android/common/app/permission/PermissionsResultAction$4;

    invoke-direct {v2, p0, p1}, Lcom/ss/android/common/app/permission/PermissionsResultAction$4;-><init>(Lcom/ss/android/common/app/permission/PermissionsResultAction;Ljava/lang/String;)V
...
.method public declared-synchronized shouldIgnorePermissionNotFound(Ljava/lang/String;)Z
    ...
    :try_start_0
    sget-object v0, Lcom/ss/android/common/app/permission/PermissionsResultAction;->TAG:Ljava/lang/String;
